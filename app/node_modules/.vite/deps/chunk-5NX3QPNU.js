...
var StandardWalletAdapter = class extends BaseWalletAdapter {
  constructor({ wallet }) {
    ...
    _StandardWalletAdapter_changed.set(this, (properties) => {
      if (__classPrivateFieldGet2(this, _StandardWalletAdapter_disconnecting, "f") || !__classPrivateFieldGet2(this, _StandardWalletAdapter_account, "f") || !__classPrivateFieldGet2(this, _StandardWalletAdapter_publicKey, "f") || !("accounts" in properties))
        return;
      ...
      if (account === __classPrivateFieldGet2(this, _StandardWalletAdapter_account, "f"))
        return;
      let publicKey;
      try {
      ...
      __classPrivateFieldGet2(this, _StandardWalletAdapter_instances, "m", _StandardWalletAdapter_connected).call(this, account, publicKey);
  ...
  async connect() {
    try {
      ...
      if (!__classPrivateFieldGet2(this, _StandardWalletAdapter_wallet, "f").accounts.length) {
        try {
          await __classPrivateFieldGet2(this, _StandardWalletAdapter_wallet, "f").features[StandardConnect].connect();
        } catch (error) {
...
_StandardWalletAdapter_account = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_publicKey = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_connecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_disconnecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_off = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_wallet = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_readyState = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_changed = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_instances = /* @__PURE__ */ new WeakSet(), _StandardWalletAdapter_connected = function _StandardWalletAdapter_connected2(account, publicKey) {
  ...
  if (account == null ? void 0 : account.features.includes(SolanaSignTransaction)) {
  ...
  if (account == null ? void 0 : account.features.includes(SolanaSignMessage)) {
  ...
  if (off) {
    __classPrivateFieldSet2(this, _StandardWalletAdapter_off, void 0, "f");
    off();
  }
  __classPrivateFieldGet2(this, _StandardWalletAdapter_instances, "m", _StandardWalletAdapter_connected).call(this, null, null);
...
var SolanaWalletAdapterWalletAccount = class extends ReadonlyWalletAccount {
...
function useStandardWalletAdapters(adapters) {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    return () => listeners2.forEach((destroy) => destroy());
  }, [on2]);
...
//# sourceMappingURL=chunk-5NX3QPNU.js.map
