...
import {
  WalletReadyState
} from "./chunk-2KCSUF7O.js";
import "./chunk-7TEABHF5.js";
import "./chunk-5GLBSZNL.js";
...
// node_modules/@solana/wallet-adapter-react-ui/lib/esm/WalletConnectButton.js
var WalletConnectButton = ({ children, disabled, onClick, ...props }) => {
...
var WalletListItem = ({ handleClick, tabIndex, wallet }) => {
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      ...
      wallet.adapter.name,
      wallet.readyState === WalletReadyState.Installed && import_react6.default.createElement("span", null, "Detected")
    )
  );
};
...
var WalletSVG = () => {
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement("circle", { cx: "48.5", cy: "48", r: "48", fill: "url(#paint0_linear_880_5115)", fillOpacity: "0.1" }),
    import_react7.default.createElement("circle", { cx: "48.5", cy: "48", r: "47", stroke: "url(#paint1_linear_880_5115)", strokeOpacity: "0.4", strokeWidth: "2" }),
    import_react7.default.createElement(
      "g",
      { clipPath: "url(#clip0_880_5115)" },
      import_react7.default.createElement("path", { d: "M65.5769 28.1523H31.4231C27.6057 28.1523 24.5 31.258 24.5 35.0754V60.9215C24.5 64.7389 27.6057 67.8446 31.4231 67.8446H65.5769C69.3943 67.8446 72.5 64.7389 72.5 60.9215V35.0754C72.5 31.258 69.3943 28.1523 65.5769 28.1523ZM69.7308 52.1523H59.5769C57.2865 52.1523 55.4231 50.289 55.4231 47.9985C55.4231 45.708 57.2864 43.8446 59.5769 43.8446H69.7308V52.1523ZM69.7308 41.0754H59.5769C55.7595 41.0754 52.6539 44.1811 52.6539 47.9985C52.6539 51.8159 55.7595 54.9215 59.5769 54.9215H69.7308V60.9215C69.7308 63.2119 67.8674 65.0754 65.5769 65.0754H31.4231C29.1327 65.0754 27.2692 63.212 27.2692 60.9215V35.0754C27.2692 32.785 29.1326 30.9215 31.4231 30.9215H65.5769C67.8673 30.9215 69.7308 32.7849 69.7308 35.0754V41.0754Z", fill: "url(#paint2_linear_880_5115)" }),
      import_react7.default.createElement("path", { d: "M61.4231 46.6172H59.577C58.8123 46.6172 58.1924 47.2371 58.1924 48.0018C58.1924 48.7665 58.8123 49.3863 59.577 49.3863H61.4231C62.1878 49.3863 62.8077 48.7664 62.8077 48.0018C62.8077 47.2371 62.1878 46.6172 61.4231 46.6172Z", fill: "url(#paint3_linear_880_5115)" })
    ),
    import_react7.default.createElement(
      "defs",
      null,
      import_react7.default.createElement(
        ...
        import_react7.default.createElement("stop", { stopColor: "#9945FF" }),
        import_react7.default.createElement("stop", { offset: "0.14", stopColor: "#8A53F4" }),
        import_react7.default.createElement("stop", { offset: "0.42", stopColor: "#6377D6" }),
        import_react7.default.createElement("stop", { offset: "0.79", stopColor: "#24B0A7" }),
        import_react7.default.createElement("stop", { offset: "0.99", stopColor: "#00D18C" }),
        import_react7.default.createElement("stop", { offset: "1", stopColor: "#00D18C" })
      ),
      import_react7.default.createElement(
        "linearGradient",
      ...
      import_react7.default.createElement(
        "clipPath",
        { id: "clip0_880_5115" },
        import_react7.default.createElement("rect", { width: "48", height: "48", fill: "white", transform: "translate(24.5 24)" })
      )
    )
  );
};
...
var WalletModal = ({ className = "", container = "body" }) => {
  ...
  const [listedWallets, collapsedWallets] = (0, import_react8.useMemo)(() => {
    const installed = [];
    const loadable = [];
    const notDetected = [];
  ...
  return portal && (0, import_react_dom.createPortal)(import_react8.default.createElement(
    ...
    import_react8.default.createElement(
      ...
      import_react8.default.createElement(
        ...
        listedWallets.length ? import_react8.default.createElement(
          import_react8.default.Fragment,
          null,
          import_react8.default.createElement("h1", { className: "wallet-adapter-modal-title" }, "Connect a wallet on Solana to continue"),
          import_react8.default.createElement(
            "ul",
            { className: "wallet-adapter-modal-list" },
            listedWallets.map((wallet) => import_react8.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet })),
            collapsedWallets.length ? import_react8.default.createElement(Collapse, { expanded, id: "wallet-adapter-modal-collapse" }, collapsedWallets.map((wallet) => import_react8.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet }))) : null
          ),
          collapsedWallets.length ? import_react8.default.createElement(
            "button",
          ...
          import_react8.default.Fragment,
          null,
          import_react8.default.createElement("h1", { className: "wallet-adapter-modal-title" }, "You'll need a wallet on Solana to continue"),
          import_react8.default.createElement(
            "div",
            { className: "wallet-adapter-modal-middle" },
            import_react8.default.createElement(WalletSVG, null)
          ),
          collapsedWallets.length ? import_react8.default.createElement(
            import_react8.default.Fragment,
            null,
            ...
            import_react8.default.createElement(
              ...
              import_react8.default.createElement("ul", { className: "wallet-adapter-modal-list" }, collapsedWallets.map((wallet) => import_react8.default.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet })))
            )
          ) : null
        )
      )
...
var WalletMultiButton = ({ children, ...props }) => {
  ...
  const base58 = (0, import_react12.useMemo)(() => publicKey == null ? void 0 : publicKey.toBase58(), [publicKey]);
