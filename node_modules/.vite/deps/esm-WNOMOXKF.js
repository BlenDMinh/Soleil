...
} from "./chunk-7TEABHF5.js";
import {
  require_base64_js,
  require_ieee754
} from "./chunk-5GLBSZNL.js";
...
var require_galois_field = __commonJS({
  "node_modules/qrcode/lib/core/galois-field.js"(exports) {
    ...
    exports.mul = function mul(x4, y4) {
      if (x4 === 0 || y4 === 0)
        return 0;
...
var require_buffer = __commonJS({
  "node_modules/qrcode/node_modules/buffer/index.js"(exports) {
    ...
    Buffer2.compare = function compare2(a4, b5) {
      ...
      if (!Buffer2.isBuffer(a4) || !Buffer2.isBuffer(b5)) {
        throw new TypeError(
      ...
      var x4 = a4.length;
      var y4 = b5.length;
      for (var i4 = 0, len = Math.min(x4, y4); i4 < len; ++i4) {
        if (a4[i4] !== b5[i4]) {
          x4 = a4[i4];
          y4 = b5[i4];
          break;
  ...
  "node_modules/dijkstrajs/dijkstra.js"(exports, module) {
    ...
    var dijkstra = {
      single_source_shortest_paths: function(graph, s3, d4) {
        ...
        open.push(s3, 0);
        var closest, u5, v3, cost_of_s_to_u, adjacent_nodes, cost_of_e, cost_of_s_to_u_plus_cost_of_e, cost_of_s_to_v, first_visit;
        while (!open.empty()) {
          closest = open.pop();
          u5 = closest.value;
      ...
      PriorityQueue: {
        ...
        default_sorter: function(a4, b5) {
          return a4.cost - b5.cost;
        },
        /**
...
var require_qrcode = __commonJS({
  "node_modules/qrcode/lib/core/qrcode.js"(exports) {
    ...
    function createCodewords(bitBuffer, version2, errorCorrectionLevel) {
      ...
      var rs3 = new ReedSolomonEncoder(ecCount);
      var offset = 0;
      ...
      for (var b5 = 0; b5 < ecTotalBlocks; b5++) {
        ...
        ecData[b5] = rs3.encode(dcData[b5]);
        offset += dataSize;
...
function p(l3, u5, i4, t3, r3) {
  var o3 = { type: l3, props: u5, key: i4, ref: t3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: r3 };
...
function w(n3, l3) {
  ...
  for (var u5; l3 < n3.__k.length; l3++)
    if (null != (u5 = n3.__k[l3]) && null != u5.__e)
      return u5.__e;
...
function _() {
  for (var n3; i = u.length; )
    n3 = u.sort(function(n4, l3) {
      ...
      var l3, u5, i4, t3, r3, o3, f5;
      n4.__d && (o3 = (r3 = (l3 = n4).__v).__e, (f5 = l3.__P) && (u5 = [], (i4 = a({}, r3)).__v = i4, t3 = A(f5, r3, i4, l3.__n, void 0 !== f5.ownerSVGElement, null, u5, null == o3 ? w(r3) : o3), T(u5, r3), t3 != o3 && k(r3)));
    });
}
function b(n3, l3, u5, i4, t3, r3, o3, f5, s3) {
  var a4, h4, p5, y4, d4, m4, k4, g5 = u5 && u5.__k || c, _5 = g5.length;
  if (f5 == e && (f5 = null != r3 ? r3[0] : _5 ? w(u5, 0) : null), a4 = 0, l3.__k = x(l3.__k, function(u6) {
    if (null != u6) {
      if (u6.__ = l3, u6.__b = l3.__b + 1, null === (p5 = g5[a4]) || p5 && u6.key == p5.key && u6.type === p5.type)
        g5[a4] = void 0;
      else
        for (h4 = 0; h4 < _5; h4++) {
          if ((p5 = g5[h4]) && u6.key == p5.key && u6.type === p5.type) {
            g5[h4] = void 0;
            break;
          }
          p5 = null;
        }
      if (y4 = A(n3, u6, p5 = p5 || e, i4, t3, r3, o3, f5, s3), (h4 = u6.ref) && p5.ref != h4 && (k4 || (k4 = []), p5.ref && k4.push(p5.ref, null, u6), k4.push(h4, u6.__c || y4, u6)), null != y4) {
        var c4;
        if (null == m4 && (m4 = y4), void 0 !== u6.__d)
          c4 = u6.__d, u6.__d = void 0;
        else if (r3 == p5 || y4 != f5 || null == y4.parentNode) {
          n:
            if (null == f5 || f5.parentNode !== n3)
              n3.appendChild(y4), c4 = null;
            else {
              for (d4 = f5, h4 = 0; (d4 = d4.nextSibling) && h4 < _5; h4 += 2)
                if (d4 == y4)
                  break n;
              n3.insertBefore(y4, f5), c4 = f5;
            }
          "option" == l3.type && (n3.value = "");
        }
        f5 = void 0 !== c4 ? c4 : y4.nextSibling, "function" == typeof l3.type && (l3.__d = f5);
      } else
        f5 && p5.__e == f5 && f5.parentNode != n3 && (f5 = w(p5));
    }
    return a4++, u6;
...
function x(n3, l3, u5) {
  if (null == u5 && (u5 = []), null == n3 || "boolean" == typeof n3)
    ...
    u5.push(l3 ? l3("string" == typeof n3 || "number" == typeof n3 ? p(null, n3, null, null, n3) : null != n3.__e || null != n3.__c ? p(n3.type, n3.props, n3.key, null, n3.__v) : n3) : n3);
  return u5;
}
function P(n3, l3, u5, i4, t3) {
  var r3;
  for (r3 in u5)
    "children" === r3 || "key" === r3 || r3 in l3 || N(n3, r3, null, u5[r3], i4);
  for (r3 in l3)
    t3 && "function" != typeof l3[r3] || "children" === r3 || "key" === r3 || "value" === r3 || "checked" === r3 || u5[r3] === l3[r3] || N(n3, r3, l3[r3], u5[r3], i4);
}
function C(n3, l3, u5) {
  "-" === l3[0] ? n3.setProperty(l3, u5) : n3[l3] = "number" == typeof u5 && false === s.test(l3) ? u5 + "px" : null == u5 ? "" : u5;
}
function N(n3, l3, u5, i4, t3) {
  var r3, o3, f5, e3, c4;
  if (t3 ? "className" === l3 && (l3 = "class") : "class" === l3 && (l3 = "className"), "style" === l3)
    if (r3 = n3.style, "string" == typeof u5)
      ...
      if (u5)
        for (c4 in u5)
          i4 && u5[c4] === i4[c4] || C(r3, c4, u5[c4]);
    }
  else
    "o" === l3[0] && "n" === l3[1] ? (o3 = l3 !== (l3 = l3.replace(/Capture$/, "")), f5 = l3.toLowerCase(), l3 = (f5 in n3 ? f5 : l3).slice(2), u5 ? (i4 || n3.addEventListener(l3, z, o3), (n3.l || (n3.l = {}))[l3] = u5) : n3.removeEventListener(l3, z, o3)) : "list" !== l3 && "tagName" !== l3 && "form" !== l3 && "type" !== l3 && "size" !== l3 && !t3 && l3 in n3 ? n3[l3] = null == u5 ? "" : u5 : "function" != typeof u5 && "dangerouslySetInnerHTML" !== l3 && (l3 !== (l3 = l3.replace(/^xlink:?/, "")) ? null == u5 || false === u5 ? n3.removeAttributeNS("http://www.w3.org/1999/xlink", l3.toLowerCase()) : n3.setAttributeNS("http://www.w3.org/1999/xlink", l3.toLowerCase(), u5) : null == u5 || false === u5 && !/^ar/.test(l3) ? n3.removeAttribute(l3) : n3.setAttribute(l3, u5));
}
function z(l3) {
  this.l[l3.type](n.event ? n.event(l3) : l3);
}
function A(l3, u5, i4, t3, r3, o3, f5, e3, c4) {
  var s3, v3, h4, p5, y4, w7, k4, g5, _5, x4, P3 = u5.type;
  ...
  try {
    n:
      if ("function" == typeof P3) {
        if (g5 = u5.props, _5 = (s3 = P3.contextType) && t3[s3.__c], x4 = s3 ? _5 ? _5.props.value : s3.__ : t3, i4.__c ? k4 = (v3 = u5.__c = i4.__c).__ = v3.__E : ("prototype" in P3 && P3.prototype.render ? u5.__c = v3 = new P3(g5, x4) : (u5.__c = v3 = new m(g5, x4), v3.constructor = P3, v3.render = E), _5 && _5.sub(v3), v3.props = g5, v3.state || (v3.state = {}), v3.context = x4, v3.__n = t3, h4 = v3.__d = true, v3.__h = []), null == v3.__s && (v3.__s = v3.state), null != P3.getDerivedStateFromProps && (v3.__s == v3.state && (v3.__s = a({}, v3.__s)), a(v3.__s, P3.getDerivedStateFromProps(g5, v3.__s))), p5 = v3.props, y4 = v3.state, h4)
          ...
          if (null == P3.getDerivedStateFromProps && g5 !== p5 && null != v3.componentWillReceiveProps && v3.componentWillReceiveProps(g5, x4), !v3.__e && null != v3.shouldComponentUpdate && false === v3.shouldComponentUpdate(g5, v3.__s, x4) || u5.__v === i4.__v && !v3.__) {
            for (v3.props = g5, v3.state = v3.__s, u5.__v !== i4.__v && (v3.__d = false), v3.__v = u5, u5.__e = i4.__e, u5.__k = i4.__k, v3.__h.length && f5.push(v3), s3 = 0; s3 < u5.__k.length; s3++)
              u5.__k[s3] && (u5.__k[s3].__ = u5);
            break n;
          }
          null != v3.componentWillUpdate && v3.componentWillUpdate(g5, v3.__s, x4), null != v3.componentDidUpdate && v3.__h.push(function() {
            v3.componentDidUpdate(p5, y4, w7);
          });
        }
        v3.context = x4, v3.props = g5, v3.state = v3.__s, (s3 = n.__r) && s3(u5), v3.__d = false, v3.__v = u5, v3.__P = l3, s3 = v3.render(v3.props, v3.state, v3.context), u5.__k = null != s3 && s3.type == d && null == s3.key ? s3.props.children : Array.isArray(s3) ? s3 : [s3], null != v3.getChildContext && (t3 = a(a({}, t3), v3.getChildContext())), h4 || null == v3.getSnapshotBeforeUpdate || (w7 = v3.getSnapshotBeforeUpdate(p5, y4)), b(l3, u5, i4, t3, r3, o3, f5, e3, c4), v3.base = u5.__e, v3.__h.length && f5.push(v3), k4 && (v3.__E = v3.__ = null), v3.__e = false;
      } else
        null == o3 && u5.__v === i4.__v ? (u5.__k = i4.__k, u5.__e = i4.__e) : u5.__e = $(i4.__e, u5, i4, t3, r3, o3, f5, c4);
    (s3 = n.diffed) && s3(u5);
  } catch (l4) {
    u5.__v = null, n.__e(l4, u5, i4);
  }
  return u5.__e;
}
function T(l3, u5) {
  n.__c && n.__c(u5, l3), l3.some(function(u6) {
    try {
      l3 = u6.__h, u6.__h = [], l3.some(function(n3) {
        n3.call(u6);
      });
    } catch (l4) {
      n.__e(l4, u6.__v);
...
function $(n3, l3, u5, i4, t3, r3, o3, f5) {
  var s3, a4, v3, h4, p5, y4 = u5.props, d4 = l3.props;
  ...
  if (null == n3) {
    ...
    n3 = t3 ? document.createElementNS("http://www.w3.org/2000/svg", l3.type) : document.createElement(l3.type, d4.is && { is: d4.is }), r3 = null, f5 = false;
  }
  if (null === l3.type)
    y4 !== d4 && n3.data != d4 && (n3.data = d4);
  else {
    if (null != r3 && (r3 = c.slice.call(n3.childNodes)), v3 = (y4 = u5.props || e).dangerouslySetInnerHTML, h4 = d4.dangerouslySetInnerHTML, !f5) {
      if (y4 === e)
        for (y4 = {}, p5 = 0; p5 < n3.attributes.length; p5++)
          y4[n3.attributes[p5].name] = n3.attributes[p5].value;
      (h4 || v3) && (h4 && v3 && h4.__html == v3.__html || (n3.innerHTML = h4 && h4.__html || ""));
    }
    P(n3, d4, y4, t3, f5), h4 ? l3.__k = [] : (l3.__k = l3.props.children, b(n3, l3, u5, i4, "foreignObject" !== l3.type && t3, r3, o3, e, f5)), f5 || ("value" in d4 && void 0 !== (s3 = d4.value) && s3 !== n3.value && N(n3, "value", s3, y4.value, false), "checked" in d4 && void 0 !== (s3 = d4.checked) && s3 !== n3.checked && N(n3, "checked", s3, y4.checked, false));
  }
  return n3;
}
function j(l3, u5, i4) {
  try {
    "function" == typeof l3 ? l3(u5) : l3.current = u5;
  } catch (l4) {
    n.__e(l4, i4);
  }
}
function D(l3, u5, i4) {
  var t3, r3, o3;
  if (n.unmount && n.unmount(l3), (t3 = l3.ref) && (t3.current && t3.current !== l3.__e || j(t3, null, u5)), i4 || "function" == typeof l3.type || (i4 = null != (r3 = l3.__e)), l3.__e = l3.__d = void 0, null != (t3 = l3.__c)) {
...
function H(l3, u5, i4) {
  var t3, r3, f5;
  n.__ && n.__(l3, u5), r3 = (t3 = i4 === o) ? null : i4 && i4.__k || u5.__k, l3 = h(d, null, [l3]), f5 = [], A(u5, (t3 ? u5 : i4 || u5).__k = l3, r3 || e, e, void 0 !== u5.ownerSVGElement, i4 && !t3 ? [i4] : r3 ? null : c.slice.call(u5.childNodes), f5, i4 || e, t3), T(f5, l3);
}
function I(n3, l3) {
  H(n3, l3, o);
}
function L(n3, l3) {
  var u5, i4;
  for (i4 in l3 = a(a({}, n3.props), l3), arguments.length > 2 && (l3.children = c.slice.call(arguments, 2)), u5 = {}, l3)
    "key" !== i4 && "ref" !== i4 && (u5[i4] = l3[i4]);
  return p(n3.type, u5, l3.key || n3.key, l3.ref || n3.ref, null);
}
function M(n3) {
  var l3 = {}, u5 = { __c: "__cC" + f++, __: n3, Consumer: function(n4, l4) {
    return n4.children(l4);
  }, Provider: function(n4) {
    var i4, t3 = this;
    return this.getChildContext || (i4 = [], this.getChildContext = function() {
      return l3[u5.__c] = t3, l3;
...
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = { __e: function(n3, l3) {
      for (var u5, i4; l3 = l3.__; )
        if ((u5 = l3.__c) && !u5.__)
          try {
            if (u5.constructor && null != u5.constructor.getDerivedStateFromError && (i4 = true, u5.setState(u5.constructor.getDerivedStateFromError(n3))), null != u5.componentDidCatch && (i4 = true, u5.componentDidCatch(n3)), i4)
              return g(u5.__E = u5);
          } catch (l4) {
            n3 = l4;
          }
      ...
      var u5;
      u5 = this.__s !== this.state ? this.__s : this.__s = a({}, this.state), "function" == typeof n3 && (n3 = n3(u5, this.props)), n3 && a(u5, n3), null != n3 && this.__v && (l3 && this.__h.push(l3), g(this));
...
var init_hooks_module = __esm({
  "node_modules/preact/hooks/dist/hooks.module.js"() {
    ...
    n.__r = function(n3) {
      ...
      if (u5) {
        var i4 = u5.__H;
        i4 && i4.__h.length && (1 !== o2.push(u5) && r2 === n.requestAnimationFrame || ((r2 = n.requestAnimationFrame) || function(n3) {
          var t4, u6 = function() {
...
var require_tslib = __commonJS({
  "node_modules/tslib/tslib.js"(exports, module) {
    ...
    (function(factory) {
      ...
      __createBinding = function(o3, m4, k4, k22) {
        if (k22 === void 0)
          k22 = k4;
        o3[k22] = m4[k4];
      };
      ...
      __values = function(o3) {
        var s3 = typeof Symbol === "function" && Symbol.iterator, m4 = s3 && o3[s3], i4 = 0;
        if (m4)
          return m4.call(o3);
      ...
      __read = function(o3, n3) {
        ...
        if (!m4)
          return o3;
        var i4 = m4.call(o3), r3, ar = [], e3;
        try {
          while ((n3 === void 0 || n3-- > 0) && !(r3 = i4.next()).done)
            ar.push(r3.value);
        } catch (error) {
          e3 = { error };
        } finally {
      ...
      __asyncGenerator = function(thisArg, _arguments, generator) {
          ...
          if (g5[n3])
            i4[n3] = function(v3) {
              return new Promise(function(a4, b5) {
                q6.push([n3, v3, a4, b5]) > 1 || resume(n3, v3);
              });
            };
        }
        ...
        function step(r3) {
          r3.value instanceof __await ? Promise.resolve(r3.value.v).then(fulfill, reject) : settle(q6[0][2], r3);
        }
      ...
      __asyncDelegator = function(o3) {
        ...
        function verb(n3, f5) {
          i4[n3] = o3[n3] ? function(v3) {
            return (p5 = !p5) ? { value: __await(o3[n3](v3)), done: n3 === "return" } : f5 ? f5(v3) : v3;
          } : f5;
        }
      };
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function car25519(o3) {
      let c4 = 1;
      for (let i4 = 0; i4 < 16; i4++) {
        let v3 = o3[i4] + c4 + 65535;
        c4 = Math.floor(v3 / 65536);
        o3[i4] = v3 - c4 * 65536;
      }
      o3[0] += c4 - 1 + 37 * (c4 - 1);
    }
    function sel25519(p5, q6, b5) {
      const c4 = ~(b5 - 1);
      for (let i4 = 0; i4 < 16; i4++) {
        const t3 = c4 & (p5[i4] ^ q6[i4]);
        p5[i4] ^= t3;
        q6[i4] ^= t3;
      }
    }
    ...
    function edadd(p5, q6) {
      const a4 = gf(), b5 = gf(), c4 = gf(), d4 = gf(), e3 = gf(), f5 = gf(), g5 = gf(), h4 = gf(), t3 = gf();
      sub(a4, p5[1], p5[0]);
      sub(t3, q6[1], q6[0]);
      mul(a4, a4, t3);
      add(b5, p5[0], p5[1]);
    ...
    function cswap(p5, q6, b5) {
      for (let i4 = 0; i4 < 4; i4++) {
        sel25519(p5[i4], q6[i4], b5);
      }
    }
    function pack(r3, p5) {
...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w7, v3, p5, pos, len) {
      while (len >= 64) {
        var a4 = v3[0];
        var b5 = v3[1];
        var c4 = v3[2];
        ...
        for (var i4 = 0; i4 < 16; i4++) {
          var j5 = pos + i4 * 4;
          w7[i4] = binary_1.readUint32BE(p5, j5);
        }
        ...
        for (var i4 = 0; i4 < 64; i4++) {
          var t1 = (((e3 >>> 6 | e3 << 32 - 6) ^ (e3 >>> 11 | e3 << 32 - 11) ^ (e3 >>> 25 | e3 << 32 - 25)) + (e3 & f5 ^ ~e3 & g5) | 0) + (h4 + (K3[i4] + w7[i4] | 0) | 0) | 0;
          var t22 = ((a4 >>> 2 | a4 << 32 - 2) ^ (a4 >>> 13 | a4 << 32 - 13) ^ (a4 >>> 22 | a4 << 32 - 22)) + (a4 & b5 ^ a4 & c4 ^ b5 & c4) | 0;
          h4 = g5;
          g5 = f5;
          f5 = e3;
          e3 = d4 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n3, p5) {
      ...
      const a4 = gf(), b5 = gf(), c4 = gf(), d4 = gf(), e3 = gf(), f5 = gf();
...
function read(buf, offset) {
  var res = 0, offset = offset || 0, shift = 0, counter = offset, b5, l3 = buf.length;
  do {
    if (counter >= l3) {
      read.bytes = 0;
...
var __spreadArray = function(to, from3, pack) {
  if (pack || arguments.length === 2)
    for (var i4 = 0, l3 = from3.length, ar; i4 < l3; i4++) {
      if (ar || !(i4 in from3)) {
        if (!ar)
...
var import_window_getters = __toESM(require_cjs8());
var import_window_metadata = __toESM(require_cjs10());
var C3 = __toESM(require_query_string());
...
function wn() {
  ...
  return { privateKey: toString2(e3.secretKey, f3), publicKey: toString2(e3.publicKey, f3) };
}
function Un() {
  const e3 = (0, import_random2.randomBytes)(Q2);
  return toString2(e3, f3);
}
function An(e3, n3) {
  const t3 = ue.sharedKey(fromString2(e3, f3), fromString2(n3, f3)), r3 = new import_hkdf.HKDF(import_sha256.SHA256, t3).expand(Q2);
  return toString2(r3, f3);
}
function _n(e3) {
  const n3 = (0, import_sha256.hash)(fromString2(e3, f3));
  return toString2(n3, f3);
}
function $n(e3) {
  const n3 = (0, import_sha256.hash)(fromString2(e3, k3));
  return toString2(n3, f3);
}
function Se(e3) {
  return fromString2(`${e3}`, W2);
}
function $3(e3) {
  return Number(toString2(e3, W2));
}
function jn(e3) {
  const n3 = Se(typeof e3.type < "u" ? e3.type : Y2);
  if ($3(n3) === A4 && typeof e3.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const t3 = typeof e3.senderPublicKey < "u" ? fromString2(e3.senderPublicKey, f3) : void 0, r3 = typeof e3.iv < "u" ? fromString2(e3.iv, f3) : (0, import_random2.randomBytes)(J2), o3 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e3.symKey, f3)).seal(r3, fromString2(e3.message, k3));
  return Ie({ type: n3, sealed: o3, iv: r3, senderPublicKey: t3 });
}
function Cn(e3) {
  const n3 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e3.symKey, f3)), { sealed: t3, iv: r3 } = Z2(e3.encoded), o3 = n3.open(r3, t3);
  if (o3 === null)
    throw new Error("Failed to decrypt");
  return toString2(o3, k3);
}
function Ie(e3) {
  if ($3(e3.type) === A4) {
    if (typeof e3.senderPublicKey > "u")
      throw new Error("Missing sender public key for type 1 envelope");
    return toString2(concat([e3.type, e3.senderPublicKey, e3.iv, e3.sealed]), K2);
  }
  return toString2(concat([e3.type, e3.iv, e3.sealed]), K2);
}
function Z2(e3) {
  const n3 = fromString2(e3, K2), t3 = n3.slice(Rn, Oe), r3 = Oe;
  if ($3(t3) === A4) {
    const d4 = r3 + Q2, l3 = d4 + J2, c4 = n3.slice(r3, d4), u5 = n3.slice(d4, l3), a4 = n3.slice(l3);
    return { type: t3, sealed: a4, iv: u5, senderPublicKey: c4 };
  }
  const o3 = r3 + J2, s3 = n3.slice(r3, o3), i4 = n3.slice(o3);
  return { type: t3, sealed: i4, iv: s3 };
}
function Dn(e3, n3) {
  const t3 = Z2(e3);
  return Pe({ type: $3(t3.type), senderPublicKey: typeof t3.senderPublicKey < "u" ? toString2(t3.senderPublicKey, f3) : void 0, receiverPublicKey: n3 == null ? void 0 : n3.receiverPublicKey });
}
function Pe(e3) {
  const n3 = (e3 == null ? void 0 : e3.type) || Y2;
  if (n3 === A4) {
...
function Vn(e3) {
  return e3.type === A4 && typeof e3.senderPublicKey == "string" && typeof e3.receiverPublicKey == "string";
}
var Mn = Object.defineProperty;
var Te = Object.getOwnPropertySymbols;
var Kn = Object.prototype.hasOwnProperty;
var kn = Object.prototype.propertyIsEnumerable;
var Re = (e3, n3, t3) => n3 in e3 ? Mn(e3, n3, { enumerable: true, configurable: true, writable: true, value: t3 }) : e3[n3] = t3;
var we = (e3, n3) => {
  for (var t3 in n3 || (n3 = {}))
    Kn.call(n3, t3) && Re(e3, t3, n3[t3]);
  if (Te)
    for (var t3 of Te(n3))
      kn.call(n3, t3) && Re(e3, t3, n3[t3]);
  return e3;
...
function x3() {
  return $e() ? b3.reactNative : ee() ? b3.node : je() ? b3.browser : b3.unknown;
}
function Ce(e3, n3) {
  let t3 = C3.parse(e3);
  return t3 = we(we({}, t3), n3), e3 = C3.stringify(t3), e3;
}
function Fn() {
...
function Ve() {
  var e3;
  const n3 = x3();
  return n3 === b3.browser ? [n3, ((e3 = (0, import_window_getters.getLocation)()) == null ? void 0 : e3.host) || "unknown"].join(":") : n3;
}
function Me(e3, n3, t3) {
  const r3 = De(), o3 = Ve();
  return [[e3, n3].join("-"), [_e, t3].join("-"), r3, o3].join("/");
}
function qn({ protocol: e3, version: n3, relayUrl: t3, sdkVersion: r3, auth: o3, projectId: s3, useOnCloseEvent: i4 }) {
  const d4 = t3.split("?"), l3 = Me(e3, n3, r3), c4 = { auth: o3, ua: l3, projectId: s3, useOnCloseEvent: i4 || void 0 }, u5 = Ce(d4[1] || "", c4);
  return d4[0] + "?" + u5;
}
function O2(e3, n3) {
...
function Xn(e3 = import_time2.FIVE_MINUTES, n3) {
...
async function ct({ id: e3, topic: n3, wcDeepLink: t3 }) {
  try {
    if (!t3)
      return;
    ...
    const s3 = `${o3}/wc?requestId=${e3}&sessionTopic=${n3}`, i4 = x3();
    i4 === b3.browser ? window.open(s3, "_self", "noreferrer noopener") : i4 === b3.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s3);
  } catch (r3) {
    console.error(r3);
  }
}
var xe = "irn";
function at(e3) {
  return (e3 == null ? void 0 : e3.relay) || { protocol: xe };
}
function ut(e3) {
...
var He = (e3, n3, t3) => n3 in e3 ? dt(e3, n3, { enumerable: true, configurable: true, writable: true, value: t3 }) : e3[n3] = t3;
var pt = (e3, n3) => {
  for (var t3 in n3 || (n3 = {}))
    lt.call(n3, t3) && He(e3, t3, n3[t3]);
  if (Fe)
    for (var t3 of Fe(n3))
      ft.call(n3, t3) && He(e3, t3, n3[t3]);
  return e3;
};
function qe(e3, n3 = "-") {
...
function mt(e3) {
  const n3 = e3.indexOf(":"), t3 = e3.indexOf("?") !== -1 ? e3.indexOf("?") : void 0, r3 = e3.substring(0, n3), o3 = e3.substring(n3 + 1, t3).split("@"), s3 = typeof t3 < "u" ? e3.substring(t3) : "", i4 = C3.parse(s3);
  return { protocol: r3, topic: ze(o3[0]), version: parseInt(o3[1], 10), symKey: i4.symKey, relay: qe(i4) };
}
function ze(e3) {
...
function yt(e3) {
  return `${e3.protocol}:${e3.topic}@${e3.version}?` + C3.stringify(pt({ symKey: e3.symKey }, Ge(e3.relay)));
}
function R2(e3) {
  const n3 = [];
...
function Ye(e3) {
  ...
  return Object.values(e3).forEach((t3) => {
    n3.push(...R2(t3.accounts));
  }), n3;
}
function Je(e3, n3) {
  const t3 = [];
  return Object.values(e3).forEach((r3) => {
    R2(r3.accounts).includes(n3) && t3.push(...r3.methods);
  }), t3;
}
function Qe(e3, n3) {
  const t3 = [];
  return Object.values(e3).forEach((r3) => {
    R2(r3.accounts).includes(n3) && t3.push(...r3.events);
  }), t3;
}
function St(e3, n3) {
  const t3 = sn(e3, n3);
...
function Rt(e3, n3) {
  ...
  return O2(o3, r3) ? (r3.forEach((i4) => {
    const { accounts: d4, methods: l3, events: c4 } = e3.namespaces[i4], u5 = R2(d4), a4 = t3[i4];
    (!O2(V2(i4, a4), u5) || !O2(a4.methods, l3) || !O2(a4.events, c4)) && (s3 = false);
  }), s3) : false;
}
function q3(e3) {
  return m3(e3, false) && e3.includes(":") ? e3.split(":").length === 2 : false;
}
function Xe(e3) {
  if (m3(e3, false) && e3.includes(":")) {
    const n3 = e3.split(":");
    if (n3.length === 3) {
      const t3 = n3[0] + ":" + n3[1];
      return !!n3[2] && q3(t3);
...
function _t(e3, n3) {
  let t3 = null;
  return m3(e3 == null ? void 0 : e3.publicKey, false) || (t3 = N10("MISSING_OR_INVALID", `${n3} controller public key should be a string`)), t3;
}
function oe(e3) {
  let n3 = true;
  return j3(e3) ? e3.length && (n3 = e3.every((t3) => m3(t3, false))) : n3 = false, n3;
}
function en(e3, n3, t3) {
  let r3 = null;
  return j3(n3) ? n3.forEach((o3) => {
    r3 || (!q3(o3) || !o3.includes(e3)) && (r3 = w4("UNSUPPORTED_CHAINS", `${t3}, chain ${o3} should be a string and conform to "namespace:chainId" format`));
  }) : r3 = w4("UNSUPPORTED_CHAINS", `${t3}, chains ${n3} should be an array of strings conforming to "namespace:chainId" format`), r3;
}
function nn(e3, n3) {
  let t3 = null;
  return Object.entries(e3).forEach(([r3, o3]) => {
    if (t3)
      return;
    const s3 = en(r3, V2(r3, o3), `${n3} requiredNamespace`);
    s3 && (t3 = s3);
  }), t3;
}
function tn(e3, n3) {
  let t3 = null;
  return j3(e3) ? e3.forEach((r3) => {
    t3 || Xe(r3) || (t3 = w4("UNSUPPORTED_ACCOUNTS", `${n3}, account ${r3} should be a string and conform to "namespace:chainId:address" format`));
  }) : t3 = w4("UNSUPPORTED_ACCOUNTS", `${n3}, accounts should be an array of strings conforming to "namespace:chainId:address" format`), t3;
}
function rn(e3, n3) {
  let t3 = null;
  return Object.values(e3).forEach((r3) => {
    if (t3)
      return;
    const o3 = tn(r3 == null ? void 0 : r3.accounts, `${n3} namespace`);
    o3 && (t3 = o3);
  }), t3;
}
function on(e3, n3) {
  let t3 = null;
  return oe(e3 == null ? void 0 : e3.methods) ? oe(e3 == null ? void 0 : e3.events) || (t3 = w4("UNSUPPORTED_EVENTS", `${n3}, events should be an array of strings or empty array for no events`)) : t3 = w4("UNSUPPORTED_METHODS", `${n3}, methods should be an array of strings or empty array for no methods`), t3;
}
function se(e3, n3) {
  let t3 = null;
  return Object.values(e3).forEach((r3) => {
...
function cn(e3) {
  return m3(e3.protocol, true);
}
function jt(e3, n3) {
  let t3 = false;
  return n3 && !e3 ? t3 = true : e3 && j3(e3) && e3.length && e3.forEach((r3) => {
    t3 = cn(r3);
  }), t3;
}
function Ct(e3) {
...
function Vt(e3) {
  return !(!e3 || typeof e3 != "object" || !e3.code || !H3(e3.code, false) || !e3.message || !m3(e3.message, false));
}
function Mt(e3) {
  return !(I3(e3) || !m3(e3.method, false));
}
function Kt(e3) {
  return !(I3(e3) || I3(e3.result) && I3(e3.error) || !H3(e3.id, false) || !m3(e3.jsonrpc, false));
}
function kt(e3) {
  return !(I3(e3) || !m3(e3.name, false));
}
function Lt(e3, n3) {
  return !(!q3(n3) || !Ye(e3).includes(n3));
}
function xt(e3, n3, t3) {
  return m3(t3, false) ? Je(e3, n3).includes(t3) : false;
}
function Ft(e3, n3, t3) {
  return m3(t3, false) ? Qe(e3, n3).includes(t3) : false;
}
function an(e3, n3, t3) {
  let r3 = null;
  const o3 = Ht(e3), s3 = qt(n3), i4 = Object.keys(o3), d4 = Object.keys(s3), l3 = un(Object.keys(e3)), c4 = un(Object.keys(n3)), u5 = l3.filter((a4) => !c4.includes(a4));
  return u5.length && (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces keys don't satisfy requiredNamespaces.
      ...
      Received: ${Object.keys(n3).toString()}`)), O2(i4, d4) || (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces chains don't satisfy required namespaces.
      Required: ${i4.toString()}
      Approved: ${d4.toString()}`)), Object.keys(n3).forEach((a4) => {
    if (!a4.includes(":") || r3)
      return;
    const g5 = R2(n3[a4].accounts);
    g5.includes(a4) || (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces accounts don't satisfy namespace accounts for ${a4}
        Required: ${a4}
...
function zt(e3, n3) {
  return H3(e3, false) && e3 <= n3.max && e3 >= n3.min;
}
...
var WsConnection = class {
  ...
  parseError(e3, url = this.url) {
    return parseConnectionError(e3, url, "WS");
  }
  resetMaxListeners() {
...
function Ui(r3, e3) {
  ...
  var o3 = r3.length, h4 = r3.charAt(0), d4 = Math.log(o3) / Math.log(256), l3 = Math.log(256) / Math.log(o3);
  function D4(u5) {
    ...
    if (u5.length === 0)
      return "";
    for (var y4 = 0, A5 = 0, v3 = 0, R3 = u5.length; v3 !== R3 && u5[v3] === 0; )
      v3++, y4++;
    for (var S3 = (R3 - v3) * l3 + 1 >>> 0, m4 = new Uint8Array(S3); v3 !== R3; ) {
      for (var T4 = u5[v3], x4 = 0, I4 = S3 - 1; (T4 !== 0 || x4 < A5) && I4 !== -1; I4--, x4++)
        T4 += 256 * m4[I4] >>> 0, m4[I4] = T4 % o3 >>> 0, T4 = T4 / o3 >>> 0;
      if (T4 !== 0)
        throw new Error("Non-zero carry");
      A5 = x4, v3++;
    }
    for (var P3 = S3 - A5; P3 !== S3 && m4[P3] === 0; )
      P3++;
    for (var K3 = h4.repeat(y4); P3 < S3; ++P3)
      K3 += r3.charAt(m4[P3]);
    return K3;
  }
  function b5(u5) {
    ...
    var y4 = 0;
    if (u5[y4] !== " ") {
      for (var A5 = 0, v3 = 0; u5[y4] === h4; )
        A5++, y4++;
      for (var R3 = (u5.length - y4) * d4 + 1 >>> 0, S3 = new Uint8Array(R3); u5[y4]; ) {
        var m4 = t3[u5.charCodeAt(y4)];
        if (m4 === 255)
          return;
        for (var T4 = 0, x4 = R3 - 1; (m4 !== 0 || T4 < v3) && x4 !== -1; x4--, T4++)
          m4 += o3 * S3[x4] >>> 0, S3[x4] = m4 % 256 >>> 0, m4 = m4 / 256 >>> 0;
        if (m4 !== 0)
          throw new Error("Non-zero carry");
        v3 = T4, y4++;
      }
      if (u5[y4] !== " ") {
        for (var I4 = R3 - v3; I4 !== R3 && S3[I4] === 0; )
          I4++;
        for (var P3 = new Uint8Array(A5 + (R3 - I4)), K3 = A5; I4 !== R3; )
          P3[K3++] = S3[I4++];
        return P3;
      }
    }
  ...
  return { encode: D4, decodeUnsafe: b5, decode: H5 };
}
var Li = Ui;
var Fi = Li;
var Pe2 = (r3) => {
...
var $i = (r3) => new TextEncoder().encode(r3);
var Mi = (r3) => new TextDecoder().decode(r3);
var Ki = class {
...
var Oe2 = (r3, e3) => new Bi({ ...r3.decoders || { [r3.prefix]: r3 }, ...e3.decoders || { [e3.prefix]: e3 } });
var ji = class {
  constructor(e3, t3, i4, s3) {
    this.name = e3, this.prefix = t3, this.baseEncode = i4, this.baseDecode = s3, this.encoder = new Ki(e3, t3, i4), this.decoder = new ki(e3, t3, s3);
  }
  encode(e3) {
...
var q4 = ({ name: r3, prefix: e3, encode: t3, decode: i4 }) => new ji(r3, e3, t3, i4);
var $4 = ({ prefix: r3, name: e3, alphabet: t3 }) => {
  const { encode: i4, decode: s3 } = Fi(t3, e3);
  return q4({ prefix: r3, name: e3, encode: i4, decode: (n3) => Pe2(s3(n3)) });
};
var Vi = (r3, e3, t3, i4) => {
  const s3 = {};
  ...
  for (let l3 = 0; l3 < n3; ++l3) {
    ...
    h4 = h4 << t3 | D4, o3 += t3, o3 >= 8 && (o3 -= 8, a4[d4++] = 255 & h4 >> o3);
  }
  if (o3 >= t3 || 255 & h4 << 8 - o3)
    throw new SyntaxError("Unexpected end of data");
  return a4;
};
var qi = (r3, e3, t3) => {
  ...
  let n3 = "", a4 = 0, o3 = 0;
  for (let h4 = 0; h4 < r3.length; ++h4)
    for (o3 = o3 << 8 | r3[h4], a4 += 8; a4 > t3; )
...
var p4 = ({ name: r3, prefix: e3, bitsPerChar: t3, alphabet: i4 }) => q4({ prefix: e3, name: r3, encode(s3) {
  return qi(s3, i4, t3);
}, decode(s3) {
  return Vi(s3, i4, t3, r3);
} });
var Gi = q4({ prefix: "\0", name: "identity", encode: (r3) => Mi(r3), decode: (r3) => $i(r3) });
var Yi = Object.freeze({ __proto__: null, identity: Gi });
var Ji = p4({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var Hi = Object.freeze({ __proto__: null, base2: Ji });
var Wi = p4({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var Xi = Object.freeze({ __proto__: null, base8: Wi });
var Zi = $4({ prefix: "9", name: "base10", alphabet: "0123456789" });
var Qi = Object.freeze({ __proto__: null, base10: Zi });
var es = p4({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var ts = p4({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var is = Object.freeze({ __proto__: null, base16: es, base16upper: ts });
var ss = p4({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var rs = p4({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var ns = p4({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var as = p4({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var os = p4({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var hs = p4({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var cs = p4({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var us = p4({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var ls = p4({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
var ds = Object.freeze({ __proto__: null, base32: ss, base32upper: rs, base32pad: ns, base32padupper: as, base32hex: os, base32hexupper: hs, base32hexpad: cs, base32hexpadupper: us, base32z: ls });
var gs = $4({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" });
var ps = $4({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var Ds = Object.freeze({ __proto__: null, base36: gs, base36upper: ps });
var ys = $4({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
var bs = $4({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var ms = Object.freeze({ __proto__: null, base58btc: ys, base58flickr: bs });
var Es = p4({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var fs = p4({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var ws = p4({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var vs = p4({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var Is = Object.freeze({ __proto__: null, base64: Es, base64pad: fs, base64url: ws, base64urlpad: vs });
var xe2 = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Cs = xe2.reduce((r3, e3, t3) => (r3[t3] = e3, r3), []);
var _s = xe2.reduce((r3, e3, t3) => (r3[e3.codePointAt(0)] = t3, r3), []);
function Rs(r3) {
  return r3.reduce((e3, t3) => (e3 += Cs[t3], e3), "");
}
function Ss(r3) {
  const e3 = [];
  for (const t3 of r3) {
    const i4 = _s[t3.codePointAt(0)];
    if (i4 === void 0)
...
var Ts = q4({ prefix: "🚀", name: "base256emoji", encode: Rs, decode: Ss });
var Ps = Object.freeze({ __proto__: null, base256emoji: Ts });
var Os = ze2;
var Ae = 128;
var xs = 127;
var As = ~xs;
var zs = Math.pow(2, 31);
function ze2(r3, e3, t3) {
  e3 = e3 || [], t3 = t3 || 0;
  for (var i4 = t3; r3 >= zs; )
    e3[t3++] = r3 & 255 | Ae, r3 /= 128;
  for (; r3 & As; )
    e3[t3++] = r3 & 255 | Ae, r3 >>>= 7;
  return e3[t3] = r3 | 0, ze2.bytes = t3 - i4 + 1, e3;
}
var Ns = ne2;
var Us = 128;
var Ne = 127;
function ne2(r3, i4) {
  ...
  do {
    ...
    a4 = r3[n3++], t3 += s3 < 28 ? (a4 & Ne) << s3 : (a4 & Ne) * Math.pow(2, s3), s3 += 7;
  } while (a4 >= Us);
  return ne2.bytes = n3 - i4, t3;
}
var Ls = Math.pow(2, 7);
var Fs = Math.pow(2, 14);
var $s = Math.pow(2, 21);
var Ms = Math.pow(2, 28);
var Ks = Math.pow(2, 35);
var ks = Math.pow(2, 42);
var Bs = Math.pow(2, 49);
var js = Math.pow(2, 56);
var Vs = Math.pow(2, 63);
var qs = function(r3) {
  return r3 < Ls ? 1 : r3 < Fs ? 2 : r3 < $s ? 3 : r3 < Ms ? 4 : r3 < Ks ? 5 : r3 < ks ? 6 : r3 < Bs ? 7 : r3 < js ? 8 : r3 < Vs ? 9 : 10;
};
var Gs = { encode: Os, decode: Ns, encodingLength: qs };
var Ue2 = Gs;
var Le = (r3, e3, t3 = 0) => (Ue2.encode(r3, e3, t3), e3);
var Fe2 = (r3) => Ue2.encodingLength(r3);
var ae2 = (r3, e3) => {
  const t3 = e3.byteLength, i4 = Fe2(r3), s3 = i4 + Fe2(t3), n3 = new Uint8Array(s3 + t3);
  return Le(r3, n3, 0), Le(t3, n3, i4), n3.set(e3, s3), new Ys(r3, t3, e3, n3);
};
var Ys = class {
  constructor(e3, t3, i4, s3) {
...
var $e2 = ({ name: r3, code: e3, encode: t3 }) => new Js(r3, e3, t3);
var Js = class {
  constructor(e3, t3, i4) {
  ...
  digest(e3) {
    if (e3 instanceof Uint8Array) {
      ...
      return t3 instanceof Uint8Array ? ae2(this.code, t3) : t3.then((i4) => ae2(this.code, i4));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
var Me2 = (r3) => async (e3) => new Uint8Array(await crypto.subtle.digest(r3, e3));
var Hs = $e2({ name: "sha2-256", code: 18, encode: Me2("SHA-256") });
var Ws = $e2({ name: "sha2-512", code: 19, encode: Me2("SHA-512") });
var Xs = Object.freeze({ __proto__: null, sha256: Hs, sha512: Ws });
var Ke = 0;
var Zs = "identity";
var ke = Pe2;
var Qs = (r3) => ae2(Ke, ke(r3));
var er = { code: Ke, name: Zs, encode: ke, digest: Qs };
var tr = Object.freeze({ __proto__: null, identity: er });
new TextEncoder(), new TextDecoder();
var Be = { ...Yi, ...Hi, ...Xi, ...Qi, ...is, ...ds, ...Ds, ...ms, ...Is, ...Ps };
({ ...Xs, ...tr });
function je2(r3) {
  return globalThis.Buffer != null ? new Uint8Array(r3.buffer, r3.byteOffset, r3.byteLength) : r3;
}
function ir(r3 = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null ? je2(globalThis.Buffer.allocUnsafe(r3)) : new Uint8Array(r3);
}
function Ve2(r3, e3, t3, i4) {
  return { name: r3, prefix: e3, encoder: { name: r3, prefix: e3, encode: t3 }, decoder: { decode: i4 } };
}
var qe2 = Ve2("utf8", "u", (r3) => "u" + new TextDecoder("utf8").decode(r3), (r3) => new TextEncoder().encode(r3.substring(1)));
var oe2 = Ve2("ascii", "a", (r3) => {
  let e3 = "a";
  ...
  r3 = r3.substring(1);
  const e3 = ir(r3.length);
  for (let t3 = 0; t3 < r3.length; t3++)
    e3[t3] = r3.charCodeAt(t3);
  return e3;
});
var sr = { utf8: qe2, "utf-8": qe2, hex: Be.base16, latin1: oe2, ascii: oe2, binary: oe2, ...Be };
function rr(r3, e3 = "utf8") {
  const t3 = sr[e3];
  if (!t3)
    throw new Error(`Unsupported encoding "${e3}"`);
  return (e3 === "utf8" || e3 === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? je2(globalThis.Buffer.from(r3, "utf-8")) : t3.decoder.decode(`${t3.prefix}${r3}`);
}
var he = "wc";
var Ge2 = 2;
var G3 = "core";
var O3 = `${he}@2:${G3}:`;
var Ye2 = { name: G3, logger: "error" };
var Je2 = { database: ":memory:" };
var He2 = "crypto";
var ce2 = "client_ed25519_seed";
var We = import_time3.ONE_DAY;
var Xe2 = "keychain";
var Ze = "0.3";
var Qe2 = "messages";
var et2 = "0.3";
...
var nt2 = "relayer";
var g4 = { message: "relayer_message", message_ack: "relayer_message_ack", connect: "relayer_connect", disconnect: "relayer_disconnect", error: "relayer_error", connection_stalled: "relayer_connection_stalled", transport_closed: "relayer_transport_closed", publish: "relayer_publish" };
...
var gt = "0.3";
var pt2 = import_time3.FIVE_SECONDS * 1e3;
var Dt2 = "pairing";
var yt2 = "0.3";
var L3 = { wc_pairingDelete: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 } } };
var _4 = { created: "history_created", updated: "history_updated", deleted: "history_deleted", sync: "history_sync" };
var bt = "history";
var mt2 = "0.3";
var Et = "expirer";
var w5 = { created: "expirer_created", deleted: "expirer_deleted", expired: "expirer_expired", sync: "expirer_sync" };
var ft2 = "0.3";
var Y3 = "verify-api";
var le2 = "https://verify.walletconnect.com";
var wt2 = class {
  constructor(e3, t3) {
    this.core = e3, this.logger = t3, this.keychain = /* @__PURE__ */ new Map(), this.name = Xe2, this.version = Ze, this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      if (!this.initialized) {
  ...
  async setKeyChain(e3) {
    await this.core.storage.setItem(this.storageKey, Wn(e3));
  }
  async getKeyChain() {
...
var vt = class {
  constructor(e3, t3, i4) {
    this.core = e3, this.logger = t3, this.name = He2, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n3 = await this.getClientSeed(), a4 = generateKeyPair(n3), o3 = Un(), h4 = We;
      return await signJWT(o3, s3, h4, a4);
    }, this.generateSharedKey = (s3, n3, a4) => {
      this.isInitialized();
      const o3 = this.getPrivateKey(s3), h4 = An(o3, n3);
      return this.setSymKey(h4, a4);
      ...
      this.isInitialized();
      const o3 = Pe(a4), h4 = safeJsonStringify3(n3);
      if (Vn(o3)) {
        const b5 = o3.senderPublicKey, H5 = o3.receiverPublicKey;
        s3 = await this.generateSharedKey(b5, H5);
      }
      const d4 = this.getSymKey(s3), { type: l3, senderPublicKey: D4 } = o3;
      return jn({ type: l3, symKey: d4, message: h4, senderPublicKey: D4 });
    }, this.decode = async (s3, n3, a4) => {
      this.isInitialized();
      const o3 = Dn(n3, a4);
      if (Vn(o3)) {
        const l3 = o3.receiverPublicKey, D4 = o3.senderPublicKey;
        s3 = await this.generateSharedKey(l3, D4);
      }
      const h4 = this.getSymKey(s3), d4 = Cn({ symKey: h4, encoded: n3 });
      return safeJsonParse3(d4);
    }, this.getPayloadType = (s3) => {
      const n3 = Z2(s3);
      return $3(n3.type);
    }, this.getPayloadSenderPublicKey = (s3) => {
      const n3 = Z2(s3);
      return n3.senderPublicKey ? toString2(n3.senderPublicKey, f3) : void 0;
    }, this.core = e3, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.keychain = i4 || new wt2(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
  ...
  async getClientSeed() {
    let e3 = "";
    try {
      e3 = this.keychain.get(ce2);
    } catch {
      e3 = Un(), await this.keychain.set(ce2, e3);
    }
    return rr(e3, "base16");
  }
  getSymKey(e3) {
...
var It = class extends a3 {
  constructor(e3, t3) {
    super(e3, t3), this.logger = e3, this.core = t3, this.messages = /* @__PURE__ */ new Map(), this.name = Qe2, this.version = et2, this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      if (!this.initialized) {
...
var cr = class extends u3 {
  constructor(e3, t3) {
    super(e3, t3), this.relayer = e3, this.logger = t3, this.events = new import_events5.EventEmitter(), this.name = it2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (i4, s3, n3) => {
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i4, message: s3, opts: n3 } });
      try {
        const a4 = (n3 == null ? void 0 : n3.ttl) || tt2, o3 = at(n3), h4 = (n3 == null ? void 0 : n3.prompt) || false, d4 = (n3 == null ? void 0 : n3.tag) || 0, l3 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), D4 = { topic: i4, message: s3, opts: { ttl: a4, relay: o3, prompt: h4, tag: d4, id: l3 } };
        this.queue.set(l3, D4);
        try {
          await await et(this.rpcPublish(i4, s3, a4, o3, h4, d4, l3), this.publishTimeout), this.relayer.events.emit(g4.publish, D4);
        } catch {
          this.logger.debug("Publishing Payload stalled"), this.relayer.events.emit(g4.connection_stalled);
          return;
        }
  ...
  rpcPublish(e3, t3, i4, s3, n3, a4, o3) {
    var h4, d4, l3, D4;
    const b5 = { method: ut(s3.protocol).publish, params: { topic: e3, message: t3, ttl: i4, prompt: n3, tag: a4 }, id: o3 };
    return I3((h4 = b5.params) == null ? void 0 : h4.prompt) && ((d4 = b5.params) == null || delete d4.prompt), I3((l3 = b5.params) == null ? void 0 : l3.tag) && ((D4 = b5.params) == null || delete D4.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: b5 }), this.relayer.request(b5);
  }
  onPublish(e3) {
  ...
  registerEventListeners() {
    this.relayer.core.heartbeat.on(import_heartbeat.HEARTBEAT_EVENTS.pulse, () => {
      this.checkQueue();
    }), this.relayer.on(g4.message_ack, (e3) => {
...
var _t2 = (r3, e3, t3) => e3 in r3 ? lr(r3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : r3[e3] = t3;
var M3 = (r3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    pr.call(e3, t3) && _t2(r3, t3, e3[t3]);
  if (Ct2)
    for (var t3 of Ct2(e3))
      Dr.call(e3, t3) && _t2(r3, t3, e3[t3]);
  return r3;
};
var de = (r3, e3) => dr(r3, gr(e3));
var Rt2 = class extends d3 {
  constructor(e3, t3) {
    super(e3, t3), this.relayer = e3, this.logger = t3, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new ur(), this.events = new import_events5.EventEmitter(), this.name = dt2, this.version = gt, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = O3, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      try {
        const n3 = at(s3), a4 = { topic: i4, relay: n3 };
      ...
      const o3 = setInterval(() => {
        !this.pending.has(i4) && this.topics.includes(i4) && (clearInterval(o3), a4.stop(this.pendingSubscriptionWatchLabel), s3(true)), a4.elapsed(this.pendingSubscriptionWatchLabel) >= pt2 && (clearInterval(o3), a4.stop(this.pendingSubscriptionWatchLabel), n3(new Error("Subscription resolution timeout")));
  ...
  async unsubscribeById(e3, t3, i4) {
    ...
    try {
      ...
      const n3 = w4("USER_DISCONNECTED", `${this.name}, ${e3}`);
  ...
  async rpcSubscribe(e3, t3) {
    ...
    try {
      ...
      this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(g4.connection_stalled);
    }
  ...
  async rpcBatchSubscribe(e3) {
    if (!e3.length)
      return;
    const t3 = e3[0].relay, i4 = { method: ut(t3.protocol).batchSubscribe, params: { topics: e3.map((s3) => s3.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i4 });
    try {
      return await await et(this.relayer.request(i4), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Payload stalled"), this.relayer.events.emit(g4.connection_stalled);
    }
  }
  rpcUnsubscribe(e3, t3, i4) {
    const s3 = { method: ut(i4.protocol).unsubscribe, params: { topic: e3, id: t3 } };
  ...
  onSubscribe(e3, t3) {
    this.setSubscription(e3, de(M3({}, t3), { id: e3 })), this.pending.delete(t3.topic);
  }
  onBatchSubscribe(e3) {
    e3.length && e3.forEach((t3) => {
      this.setSubscription(t3.id, M3({}, t3)), this.pending.delete(t3.topic);
    });
  }
  ...
  addSubscription(e3, t3) {
    this.subscriptions.set(e3, M3({}, t3)), this.topicMap.set(t3.topic, e3), this.events.emit(C4.created, t3);
  }
  getSubscription(e3) {
  ...
  deleteSubscription(e3, t3) {
    ...
    this.subscriptions.delete(e3), this.topicMap.delete(i4.topic, e3), this.events.emit(C4.deleted, de(M3({}, i4), { reason: t3 }));
  }
  async persist() {
  ...
  async batchSubscribe(e3) {
    ...
    j3(t3) && this.onBatchSubscribe(t3.map((i4, s3) => de(M3({}, e3[s3]), { id: i4 })));
  }
  async onConnect() {
  ...
  registerEventListeners() {
    ...
    }), this.relayer.on(g4.connect, async () => {
      await this.onConnect();
    }), this.relayer.on(g4.disconnect, () => {
      this.onDisconnect();
    }), this.events.on(C4.created, async (e3) => {
      const t3 = C4.created;
      this.logger.info(`Emitting ${t3}`), this.logger.debug({ type: "event", event: t3, data: e3 }), await this.persist();
    }), this.events.on(C4.deleted, async (e3) => {
      const t3 = C4.deleted;
      this.logger.info(`Emitting ${t3}`), this.logger.debug({ type: "event", event: t3, data: e3 }), await this.persist();
    });
  }
...
var Tt2 = (r3, e3, t3) => e3 in r3 ? yr(r3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : r3[e3] = t3;
var Er = (r3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    br.call(e3, t3) && Tt2(r3, t3, e3[t3]);
  if (St2)
    for (var t3 of St2(e3))
      mr.call(e3, t3) && Tt2(r3, t3, e3[t3]);
  return r3;
};
var Pt2 = class extends g3 {
  constructor(e3) {
    super(e3), this.protocol = "wc", this.version = 2, this.events = new import_events5.EventEmitter(), this.name = nt2, this.transportExplicitlyClosed = false, this.initialized = false, this.reconnecting = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.request = async (t3) => {
    ...
    }, this.core = e3.core, this.logger = typeof e3.logger < "u" && typeof e3.logger != "string" ? (0, import_logger.generateChildLogger)(e3.logger, this.name) : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: e3.logger || rt2 })), this.messages = new It(this.logger, e3.core), this.subscriber = new Rt2(this, this.logger), this.publisher = new cr(this, this.logger), this.relayUrl = (e3 == null ? void 0 : e3.relayUrl) || ue2, this.projectId = e3.projectId, this.provider = {};
  }
  async init() {
  ...
  async subscribe(e3, t3) {
    ...
    return s3 || (await Promise.all([new Promise((n3) => {
      this.subscriber.once(C4.created, (a4) => {
        a4.topic === e3 && n3();
      });
    }), new Promise(async (n3) => {
      s3 = await this.subscriber.subscribe(e3, t3), n3();
    })]), s3);
  }
  ...
  async transportClose() {
    this.transportExplicitlyClosed = true, this.connected && (await this.provider.disconnect(), this.events.emit(g4.transport_closed));
  }
    ...
    if (this.transportExplicitlyClosed = false, !this.reconnecting) {
      ...
      try {
        await Promise.all([new Promise((t3) => {
          this.initialized || t3(), this.subscriber.once(C4.resubscribed, () => {
            t3();
          });
        }), await Promise.race([new Promise(async (t3, i4) => {
          await et(this.provider.connect(), 5e3, "socket stalled").catch((s3) => i4(s3)).then(() => t3()).finally(() => this.removeListener(g4.transport_closed, this.rejectTransportOpen));
        }), new Promise((t3) => this.once(g4.transport_closed, this.rejectTransportOpen))])]);
      } catch (t3) {
        this.logger.error(t3);
        const i4 = t3;
        if (!this.isConnectionStalled(i4.message))
          throw t3;
        this.events.emit(g4.transport_closed);
      } finally {
  ...
  async createProvider() {
    ...
    this.provider = new JsonRpcProvider(new esm_default(qn({ sdkVersion: ht, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e3, useOnCloseEvent: true }))), this.registerProviderListeners();
  }
  ...
  async shouldIgnoreMessageEvent(e3) {
    const { topic: t3, message: i4 } = e3;
    return await this.subscriber.isSubscribed(t3) ? this.messages.has(t3, i4) : true;
  }
  async onProviderPayload(e3) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e3 }), isJsonRpcRequest(e3)) {
      if (!e3.method.endsWith(at2))
        return;
      const t3 = e3.params, { topic: i4, message: s3, publishedAt: n3 } = t3.data, a4 = { topic: i4, message: s3, publishedAt: n3 };
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(Er({ type: "event", event: t3.id }, a4)), this.events.emit(t3.id, a4), await this.acknowledgePayload(e3), await this.onMessageEvent(a4);
    } else
      isJsonRpcResponse(e3) && this.events.emit(g4.message_ack, e3);
  }
  async onMessageEvent(e3) {
    await this.shouldIgnoreMessageEvent(e3) || (this.events.emit(g4.message, e3), await this.recordMessageEvent(e3));
  }
  ...
  registerProviderListeners() {
    this.provider.on(U2.payload, (e3) => this.onProviderPayload(e3)), this.provider.on(U2.connect, () => {
      this.events.emit(g4.connect);
    }), this.provider.on(U2.disconnect, () => {
      this.onProviderDisconnect();
    }), this.provider.on(U2.error, (e3) => {
      this.logger.error(e3), this.events.emit(g4.error, e3);
    });
  }
  registerEventListeners() {
    this.events.on(g4.connection_stalled, async () => {
      await this.restartTransport();
    });
  }
  onProviderDisconnect() {
    this.events.emit(g4.disconnect), this.attemptToReconnect();
  }
  attemptToReconnect() {
...
var xt2 = (r3, e3, t3) => e3 in r3 ? fr(r3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : r3[e3] = t3;
var At2 = (r3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    wr.call(e3, t3) && xt2(r3, t3, e3[t3]);
  if (Ot)
    for (var t3 of Ot(e3))
      vr.call(e3, t3) && xt2(r3, t3, e3[t3]);
  return r3;
};
var zt2 = class extends p3 {
  constructor(e3, t3, i4, s3 = O3, n3 = void 0) {
    super(e3, t3, i4, s3), this.core = e3, this.logger = t3, this.name = i4, this.map = /* @__PURE__ */ new Map(), this.version = ut2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((a4) => {
        this.getKey && a4 !== null && !I3(a4) ? this.map.set(this.getKey(a4), a4) : Ut(a4) ? this.map.set(a4.id, a4) : At(a4) && this.map.set(a4.topic, a4);
      }), this.cached = [], this.initialized = true);
    ...
    }, this.get = (a4) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: a4 }), this.getData(a4)), this.getAll = (a4) => (this.isInitialized(), a4 ? this.values.filter((o3) => Object.keys(a4).every((h4) => (0, import_lodash.default)(o3[h4], a4[h4]))) : this.values), this.update = async (a4, o3) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: a4, update: o3 });
      const h4 = At2(At2({}, this.getData(a4)), o3);
      this.map.set(a4, h4), await this.persist();
...
var Nt = class {
  constructor(e3, t3) {
    this.core = e3, this.logger = t3, this.name = Dt2, this.version = yt2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = O3, this.ignoredPayloadTypes = [A4], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i4 = Un(), s3 = await this.core.crypto.setSymKey(i4), n3 = ot(import_time3.FIVE_MINUTES), a4 = { protocol: st2 }, o3 = { topic: s3, expiry: n3, relay: a4, active: false }, h4 = yt({ protocol: this.core.protocol, version: this.core.version, topic: s3, symKey: i4, relay: a4 });
      return await this.pairings.set(s3, o3), await this.core.relayer.subscribe(s3), this.core.expirer.set(s3, n3), { topic: s3, uri: h4 };
    }, this.pair = async (i4) => {
      this.isInitialized(), this.isValidPair(i4);
      const { topic: s3, symKey: n3, relay: a4 } = mt(i4.uri);
      if (this.pairings.keys.includes(s3))
        throw new Error(`Pairing already exists: ${s3}`);
      if (this.core.crypto.hasKeys(s3))
        throw new Error(`Keychain already exists: ${s3}`);
      const o3 = ot(import_time3.FIVE_MINUTES), h4 = { topic: s3, relay: a4, expiry: o3, active: false };
      return await this.pairings.set(s3, h4), await this.core.crypto.setSymKey(n3, s3), await this.core.relayer.subscribe(s3, { relay: a4 }), this.core.expirer.set(s3, o3), i4.activatePairing && await this.activate({ topic: s3 }), h4;
    }, this.activate = async ({ topic: i4 }) => {
      this.isInitialized();
      const s3 = ot(import_time3.THIRTY_DAYS);
      ...
      const { topic: s3 } = i4;
      if (this.pairings.keys.includes(s3)) {
        const n3 = await this.sendRequest(s3, "wc_pairingPing", {}), { done: a4, resolve: o3, reject: h4 } = Xn();
        this.events.once(it("pairing_ping", n3), ({ error: d4 }) => {
          d4 ? h4(d4) : o3();
        }), await a4();
      }
      ...
      const { topic: s3 } = i4;
      this.pairings.keys.includes(s3) && (await this.sendRequest(s3, "wc_pairingDelete", w4("USER_DISCONNECTED")), await this.deletePairing(s3));
    }, this.sendRequest = async (i4, s3, n3) => {
      const a4 = formatJsonRpcRequest(s3, n3), o3 = await this.core.crypto.encode(i4, a4), h4 = L3[s3].req;
      return this.core.history.set(i4, a4), this.core.relayer.publish(i4, o3, h4), a4.id;
    }, this.sendResult = async (i4, s3, n3) => {
      const a4 = formatJsonRpcResult(i4, n3), o3 = await this.core.crypto.encode(s3, a4), h4 = await this.core.history.get(s3, i4), d4 = L3[h4.request.method].res;
      await this.core.relayer.publish(s3, o3, d4), await this.core.history.resolve(a4);
    }, this.sendError = async (i4, s3, n3) => {
      const a4 = formatJsonRpcError(i4, n3), o3 = await this.core.crypto.encode(s3, a4), h4 = await this.core.history.get(s3, i4), d4 = L3[h4.request.method] ? L3[h4.request.method].res : L3.unregistered_method.res;
      await this.core.relayer.publish(s3, o3, d4), await this.core.history.resolve(a4);
    }, this.deletePairing = async (i4, s3) => {
      await this.core.relayer.unsubscribe(i4), await Promise.all([this.pairings.delete(i4, w4("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i4), s3 ? Promise.resolve() : this.core.expirer.del(i4)]);
    }, this.cleanup = async () => {
      const i4 = this.pairings.getAll().filter((s3) => st(s3.expiry));
      await Promise.all(i4.map((s3) => this.deletePairing(s3.topic)));
    }, this.onRelayEventRequest = (i4) => {
      const { topic: s3, payload: n3 } = i4, a4 = n3.method;
      if (this.pairings.keys.includes(s3))
        switch (a4) {
          case "wc_pairingPing":
      ...
      const { id: n3 } = s3;
      setTimeout(() => {
        isJsonRpcResult(s3) ? this.events.emit(it("pairing_ping", n3), {}) : isJsonRpcError(s3) && this.events.emit(it("pairing_ping", n3), { error: s3.error });
      }, 500);
      ...
      try {
        if (this.registeredMethods.includes(a4))
          return;
        const o3 = w4("WC_METHOD_UNSUPPORTED", a4);
        await this.sendError(n3, i4, o3), this.logger.error(o3);
      } catch (o3) {
        await this.sendError(n3, i4, o3), this.logger.error(o3);
      }
    }, this.onUnknownRpcMethodResponse = (i4) => {
      this.registeredMethods.includes(i4) || this.logger.error(w4("WC_METHOD_UNSUPPORTED", i4));
    }, this.isValidPair = (i4) => {
      if (!Dt(i4)) {
    ...
    }, this.core = e3, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.pairings = new zt2(this.core, this.logger, this.name, this.storagePrefix);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
  ...
  registerRelayerEvents() {
    this.core.relayer.on(g4.message, async (e3) => {
      const { topic: t3, message: i4 } = e3;
      if (this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i4)))
        return;
      const s3 = await this.core.crypto.decode(t3, i4);
      isJsonRpcRequest(s3) ? (this.core.history.set(t3, s3), this.onRelayEventRequest({ topic: t3, payload: s3 })) : isJsonRpcResponse(s3) && (await this.core.history.resolve(s3), this.onRelayEventResponse({ topic: t3, payload: s3 }));
    });
  }
  registerExpirerEvents() {
    this.core.expirer.on(w5.expired, async (e3) => {
...
var Ut2 = class extends h3 {
  constructor(e3, t3) {
    super(e3, t3), this.core = e3, this.logger = t3, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = bt, this.version = mt2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i4, request: s3, chainId: n3 }), this.records.has(s3.id))
        return;
      const a4 = { id: s3.id, topic: i4, request: { method: s3.method, params: s3.params || null }, chainId: n3 };
      ...
      typeof s3.response > "u" && (s3.response = isJsonRpcError(i4) ? { error: i4.error } : { result: i4.result }, this.records.set(s3.id, s3), this.events.emit(_4.updated, s3));
      ...
      this.isInitialized(), this.logger.debug("Deleting record"), this.logger.trace({ type: "method", method: "delete", id: s3 }), this.values.forEach((n3) => {
        if (n3.topic === i4) {
          if (typeof s3 < "u" && n3.id !== s3)
            return;
          this.records.delete(n3.id), this.events.emit(_4.deleted, n3);
        }
      });
...
var Lt2 = class extends E4 {
  constructor(e3, t3) {
    super(e3, t3), this.core = e3, this.logger = t3, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = Et, this.version = ft2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      ...
      this.expirations.set(n3, a4), this.checkExpiry(n3, a4), this.events.emit(w5.created, { target: n3, expiration: a4 });
    }, this.get = (i4) => {
      this.isInitialized();
      const s3 = this.formatTarget(i4);
      ...
      if (this.isInitialized(), this.has(i4)) {
        ...
        this.expirations.delete(s3), this.events.emit(w5.deleted, { target: s3, expiration: n3 });
      }
    }, this.on = (i4, s3) => {
      this.events.on(i4, s3);
    }, this.once = (i4, s3) => {
  ...
  async persist() {
    await this.setExpirations(this.values), this.events.emit(w5.sync);
  }
  async restore() {
    try {
  ...
  expire(e3, t3) {
    this.expirations.delete(e3), this.events.emit(w5.expired, { target: e3, expiration: t3 });
  }
  checkExpirations() {
    this.core.relayer.connected && this.expirations.forEach((e3, t3) => this.checkExpiry(t3, e3));
  }
  registerEventListeners() {
    this.core.heartbeat.on(import_heartbeat.HEARTBEAT_EVENTS.pulse, () => this.checkExpirations()), this.events.on(w5.created, (e3) => {
      const t3 = w5.created;
      this.logger.info(`Emitting ${t3}`), this.logger.debug({ type: "event", event: t3, data: e3 }), this.persist();
    }), this.events.on(w5.expired, (e3) => {
      const t3 = w5.expired;
      this.logger.info(`Emitting ${t3}`), this.logger.debug({ type: "event", event: t3, data: e3 }), this.persist();
    }), this.events.on(w5.deleted, (e3) => {
      const t3 = w5.deleted;
      this.logger.info(`Emitting ${t3}`), this.logger.debug({ type: "event", event: t3, data: e3 }), this.persist();
    });
  }
...
var Ft2 = class extends y3 {
  constructor(e3, t3) {
    super(e3, t3), this.projectId = e3, this.logger = t3, this.name = Y3, this.initialized = false, this.init = async (i4) => {
      $e() || !je() || (this.verifyUrl = (i4 == null ? void 0 : i4.verifyUrl) || le2, await this.createIframe());
    }, this.register = async (i4) => {
      var s3;
      this.initialized || await this.init(), this.iframe && ((s3 = this.iframe.contentWindow) == null || s3.postMessage(i4.attestationId, this.verifyUrl), this.logger.info(`postMessage sent: ${i4.attestationId} ${this.verifyUrl}`));
    }, this.resolve = async (i4) => {
      var s3;
      if (this.isDevEnv)
        return "";
      this.logger.info(`resolving attestation: ${i4.attestationId}`);
      const n3 = this.startAbortTimer(import_time3.FIVE_SECONDS), a4 = await fetch(`${this.verifyUrl}/attestation/${i4.attestationId}`, { signal: this.abortController.signal });
      return clearTimeout(n3), a4.status === 200 ? (s3 = await a4.json()) == null ? void 0 : s3.origin : "";
    }, this.createIframe = async () => {
      try {
        await Promise.race([new Promise((i4, s3) => {
          if (document.getElementById(Y3))
            return i4();
          const n3 = document.createElement("iframe");
          n3.setAttribute("id", Y3), n3.setAttribute("src", `${this.verifyUrl}/${this.projectId}`), n3.style.display = "none", n3.addEventListener("load", () => {
            this.initialized = true, i4();
          }), n3.addEventListener("error", (a4) => {
            s3(a4);
    ...
    }, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.verifyUrl = le2, this.abortController = new AbortController(), this.isDevEnv = ee() && process.env.IS_VITEST;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var Mt2 = (r3, e3, t3) => e3 in r3 ? Ir(r3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : r3[e3] = t3;
var Kt2 = (r3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    Cr.call(e3, t3) && Mt2(r3, t3, e3[t3]);
  if ($t2)
    for (var t3 of $t2(e3))
      _r.call(e3, t3) && Mt2(r3, t3, e3[t3]);
  return r3;
};
var J3 = class extends n2 {
  constructor(e3) {
    super(e3), this.protocol = he, this.version = Ge2, this.name = G3, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i4, s3) => this.events.on(i4, s3), this.once = (i4, s3) => this.events.once(i4, s3), this.off = (i4, s3) => this.events.off(i4, s3), this.removeListener = (i4, s3) => this.events.removeListener(i4, s3), this.projectId = e3 == null ? void 0 : e3.projectId, this.relayUrl = (e3 == null ? void 0 : e3.relayUrl) || ue2;
    const t3 = typeof (e3 == null ? void 0 : e3.logger) < "u" && typeof (e3 == null ? void 0 : e3.logger) != "string" ? e3.logger : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: (e3 == null ? void 0 : e3.logger) || Ye2.logger }));
    this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new vt(this, this.logger, e3 == null ? void 0 : e3.keychain), this.history = new Ut2(this, this.logger), this.expirer = new Lt2(this, this.logger), this.storage = e3 != null && e3.storage ? e3.storage : new import_keyvaluestorage.default(Kt2(Kt2({}, Je2), e3 == null ? void 0 : e3.storageOptions)), this.relayer = new Pt2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Nt(this, this.logger), this.verify = new Ft2(this.projectId || "", this.logger);
  }
  static async init(e3) {
    const t3 = new J3(e3);
    await t3.initialize();
    const i4 = await t3.crypto.getClientId();
    return await t3.storage.setItem(lt2, i4), t3;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var X2 = "client";
var b4 = `${j4}@${J4}:${X2}:`;
var G4 = { name: X2, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
var ee2 = "WALLETCONNECT_DEEPLINK_CHOICE";
var se2 = "proposal";
var te = "Proposal expired";
var ie2 = "session";
var C5 = import_time4.SEVEN_DAYS;
var ne3 = "engine";
...
var $5 = { min: import_time4.FIVE_MINUTES, max: import_time4.SEVEN_DAYS };
var re2 = "request";
...
var ce3 = (d4, n3, e3) => n3 in d4 ? Ze2(d4, n3, { enumerable: true, configurable: true, writable: true, value: e3 }) : d4[n3] = e3;
var w6 = (d4, n3) => {
  for (var e3 in n3 || (n3 = {}))
    ts2.call(n3, e3) && ce3(d4, e3, n3[e3]);
  if (ae3)
    for (var e3 of ae3(n3))
      is2.call(n3, e3) && ce3(d4, e3, n3[e3]);
  return d4;
};
var H4 = (d4, n3) => es2(d4, ss2(n3));
var ns2 = class extends S2 {
  constructor(n3) {
    super(n3), this.name = ne3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [A4], this.init = async () => {
      ...
      this.isInitialized();
      const s3 = H4(w6({}, e3), { requiredNamespaces: e3.requiredNamespaces || {}, optionalNamespaces: e3.optionalNamespaces || {} });
      await this.isValidConnect(s3);
      const { pairingTopic: t3, requiredNamespaces: i4, optionalNamespaces: r3, sessionProperties: o3, relays: a4 } = s3;
      let l3 = t3, h4, I4 = false;
      if (l3 && (I4 = this.client.core.pairing.pairings.get(l3).active), !l3 || !I4) {
        const { topic: v3, uri: y4 } = await this.client.core.pairing.create();
        l3 = v3, h4 = y4;
      }
      const g5 = await this.client.core.crypto.generateKeyPair(), E6 = w6({ requiredNamespaces: i4, optionalNamespaces: r3, relays: a4 ?? [{ protocol: st2 }], proposer: { publicKey: g5, metadata: this.client.metadata } }, o3 && { sessionProperties: o3 }), { reject: m4, resolve: V4, done: U3 } = Xn(import_time4.FIVE_MINUTES, te);
      if (this.events.once(it("session_connect"), async ({ error: v3, session: y4 }) => {
        if (v3)
          m4(v3);
        else if (y4) {
          y4.self.publicKey = g5;
          const F4 = H4(w6({}, y4), { requiredNamespaces: y4.requiredNamespaces, optionalNamespaces: y4.optionalNamespaces });
          await this.client.session.set(y4.topic, F4), await this.setExpiry(y4.topic, y4.expiry), l3 && await this.client.core.pairing.updateMetadata({ topic: l3, metadata: y4.peer.metadata }), V4(F4);
        }
      }), !l3) {
        const { message: v3 } = N10("NO_MATCHING_KEY", `connect() pairing topic: ${l3}`);
        throw new Error(v3);
      }
      const A5 = await this.sendRequest(l3, "wc_sessionPropose", E6), le3 = ot(import_time4.FIVE_MINUTES);
      return await this.setProposal(A5, w6({ id: A5, expiry: le3 }, E6)), { uri: h4, approval: U3 };
      ...
      const { id: s3, relayProtocol: t3, namespaces: i4, sessionProperties: r3 } = e3, o3 = this.client.proposal.get(s3);
      let { pairingTopic: a4, proposer: l3, requiredNamespaces: h4, optionalNamespaces: I4 } = o3;
      a4 = a4 || "", F3(h4) || (h4 = St(i4, "approve()"));
      const g5 = await this.client.core.crypto.generateKeyPair(), E6 = l3.publicKey, m4 = await this.client.core.crypto.generateSharedKey(g5, E6);
      a4 && s3 && (await this.client.core.pairing.updateMetadata({ topic: a4, metadata: l3.metadata }), await this.sendResult(s3, a4, { relay: { protocol: t3 ?? "irn" }, responderPublicKey: g5 }), await this.client.proposal.delete(s3, w4("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a4 }));
      const V4 = w6({ relay: { protocol: t3 ?? "irn" }, namespaces: i4, requiredNamespaces: h4, optionalNamespaces: I4, pairingTopic: a4, controller: { publicKey: g5, metadata: this.client.metadata }, expiry: ot(C5) }, r3 && { sessionProperties: r3 });
      await this.client.core.relayer.subscribe(m4), await this.sendRequest(m4, "wc_sessionSettle", V4);
      const U3 = H4(w6({}, V4), { topic: m4, pairingTopic: a4, acknowledged: false, self: V4.controller, peer: { publicKey: l3.publicKey, metadata: l3.metadata }, controller: g5 });
      return await this.client.session.set(m4, U3), await this.setExpiry(m4, ot(C5)), { topic: m4, acknowledged: () => new Promise((A5) => setTimeout(() => A5(this.client.session.get(m4)), 500)) };
      ...
      i4 && (await this.sendError(s3, i4, t3), await this.client.proposal.delete(s3, w4("USER_DISCONNECTED")));
    }, this.update = async (e3) => {
      this.isInitialized(), await this.isValidUpdate(e3);
      const { topic: s3, namespaces: t3 } = e3, i4 = await this.sendRequest(s3, "wc_sessionUpdate", { namespaces: t3 }), { done: r3, resolve: o3, reject: a4 } = Xn();
      return this.events.once(it("session_update", i4), ({ error: l3 }) => {
        l3 ? a4(l3) : o3();
      }), await this.client.session.update(s3, { namespaces: t3 }), { acknowledged: r3 };
    }, this.extend = async (e3) => {
      this.isInitialized(), await this.isValidExtend(e3);
      const { topic: s3 } = e3, t3 = await this.sendRequest(s3, "wc_sessionExtend", {}), { done: i4, resolve: r3, reject: o3 } = Xn();
      return this.events.once(it("session_extend", t3), ({ error: a4 }) => {
        a4 ? o3(a4) : r3();
      }), await this.setExpiry(s3, ot(C5)), { acknowledged: i4 };
    }, this.request = async (e3) => {
      this.isInitialized(), await this.isValidRequest(e3);
      const { chainId: s3, request: t3, topic: i4, expiry: r3 } = e3, o3 = await this.sendRequest(i4, "wc_sessionRequest", { request: t3, chainId: s3 }, r3), { done: a4, resolve: l3, reject: h4 } = Xn(r3);
      this.events.once(it("session_request", o3), ({ error: g5, result: E6 }) => {
        g5 ? h4(g5) : l3(E6);
      }), this.client.events.emit("session_request_sent", { topic: i4, request: t3, chainId: s3, id: o3 });
      const I4 = await this.client.core.storage.getItem(ee2);
      return ct({ id: o3, topic: i4, wcDeepLink: I4 }), await a4();
    }, this.respond = async (e3) => {
      this.isInitialized(), await this.isValidRespond(e3);
      const { topic: s3, response: t3 } = e3, { id: i4 } = t3;
      isJsonRpcResult(t3) ? await this.sendResult(i4, s3, t3.result) : isJsonRpcError(t3) && await this.sendError(i4, s3, t3.error), this.deletePendingSessionRequest(e3.response.id, { message: "fulfilled", code: 0 });
    }, this.ping = async (e3) => {
      this.isInitialized(), await this.isValidPing(e3);
      const { topic: s3 } = e3;
      if (this.client.session.keys.includes(s3)) {
        const t3 = await this.sendRequest(s3, "wc_sessionPing", {}), { done: i4, resolve: r3, reject: o3 } = Xn();
      ...
      await this.sendRequest(s3, "wc_sessionEvent", { event: t3, chainId: i4 });
      ...
      if (this.client.session.keys.includes(s3)) {
        ...
        let i4;
        const r3 = (o3) => {
          (o3 == null ? void 0 : o3.id.toString()) === t3 && (this.client.core.relayer.events.removeListener(g4.message_ack, r3), i4());
        };
        await Promise.all([new Promise((o3) => {
          i4 = o3, this.client.core.relayer.on(g4.message_ack, r3);
        }), this.sendRequest(s3, "wc_sessionDelete", w4("USER_DISCONNECTED"), void 0, t3)]), await this.deleteSession(s3);
      } else
        await this.client.core.pairing.disconnect({ topic: s3 });
    }, this.find = (e3) => (this.isInitialized(), this.client.session.getAll().filter((s3) => Rt(s3, e3))), this.getPendingSessionRequests = () => (this.isInitialized(), this.client.pendingRequest.getAll()), this.cleanupDuplicatePairings = async (e3) => {
      try {
        const s3 = this.client.core.pairing.pairings.get(e3.pairingTopic), t3 = this.client.core.pairing.pairings.getAll().filter((i4) => {
          var r3, o3;
          return ((r3 = i4.peerMetadata) == null ? void 0 : r3.url) && ((o3 = i4.peerMetadata) == null ? void 0 : o3.url) === e3.peer.metadata.url && i4.topic && i4.topic !== s3.topic;
        });
        if (t3.length === 0)
          return;
      ...
      await this.client.core.relayer.unsubscribe(e3), this.client.session.delete(e3, w4("USER_DISCONNECTED")), this.client.core.crypto.keychain.has(t3.publicKey) && await this.client.core.crypto.deleteKeyPair(t3.publicKey), this.client.core.crypto.keychain.has(e3) && await this.client.core.crypto.deleteSymKey(e3), s3 || this.client.core.expirer.del(e3);
    }, this.deleteProposal = async (e3, s3) => {
      await Promise.all([this.client.proposal.delete(e3, w4("USER_DISCONNECTED")), s3 ? Promise.resolve() : this.client.core.expirer.del(e3)]);
    }, this.deletePendingSessionRequest = async (e3, s3, t3 = false) => {
      await Promise.all([this.client.pendingRequest.delete(e3, s3), t3 ? Promise.resolve() : this.client.core.expirer.del(e3)]);
      ...
      const s3 = O4.wc_sessionRequest.req.ttl, { id: t3, topic: i4, params: r3 } = e3;
      await this.client.pendingRequest.set(t3, { id: t3, topic: i4, params: r3 }), s3 && this.client.core.expirer.set(t3, ot(s3));
    }, this.sendRequest = async (e3, s3, t3, i4, r3) => {
      const o3 = formatJsonRpcRequest(s3, t3);
      if (je() && oe3.includes(s3)) {
        const h4 = $n(JSON.stringify(o3));
        await this.client.core.verify.register({ attestationId: h4 });
      }
      const a4 = await this.client.core.crypto.encode(e3, o3), l3 = O4[s3].req;
      return i4 && (l3.ttl = i4), r3 && (l3.id = r3), this.client.core.history.set(e3, o3), this.client.core.relayer.publish(e3, a4, l3), o3.id;
    }, this.sendResult = async (e3, s3, t3) => {
      const i4 = formatJsonRpcResult(e3, t3), r3 = await this.client.core.crypto.encode(s3, i4), o3 = await this.client.core.history.get(s3, e3), a4 = O4[o3.request.method].res;
      this.client.core.relayer.publish(s3, r3, a4), await this.client.core.history.resolve(i4);
    }, this.sendError = async (e3, s3, t3) => {
      const i4 = formatJsonRpcError(e3, t3), r3 = await this.client.core.crypto.encode(s3, i4), o3 = await this.client.core.history.get(s3, e3), a4 = O4[o3.request.method].res;
      this.client.core.relayer.publish(s3, r3, a4), await this.client.core.history.resolve(i4);
    }, this.cleanup = async () => {
      const e3 = [], s3 = [];
      ...
      try {
        this.isValidConnect(w6({}, s3.params));
        const r3 = ot(import_time4.FIVE_MINUTES), o3 = w6({ id: i4, pairingTopic: e3, expiry: r3 }, t3);
        await this.setProposal(i4, o3);
        const a4 = $n(JSON.stringify(s3)), l3 = await this.getVerifyContext(a4, o3.proposer.metadata);
        this.client.events.emit("session_proposal", { id: i4, params: o3, verifyContext: l3 });
      } catch (r3) {
        await this.sendError(i4, e3, r3), this.client.logger.error(r3);
      }
      ...
      if (isJsonRpcResult(s3)) {
        ...
        const r3 = this.client.proposal.get(t3);
        ...
        const l3 = await this.client.core.crypto.generateSharedKey(o3, a4);
        ...
        this.client.logger.trace({ type: "method", method: "onSessionProposeResponse", subscriptionId: h4 }), await this.client.core.pairing.activate({ topic: e3 });
      } else
        isJsonRpcError(s3) && (await this.client.proposal.delete(t3, w4("USER_DISCONNECTED")), this.events.emit(it("session_connect"), { error: s3.error }));
    }, this.onSessionSettleRequest = async (e3, s3) => {
      const { id: t3, params: i4 } = s3;
      try {
        this.isValidSessionSettleRequest(i4);
        const { relay: r3, controller: o3, expiry: a4, namespaces: l3, requiredNamespaces: h4, optionalNamespaces: I4, sessionProperties: g5, pairingTopic: E6 } = s3.params, m4 = w6({ topic: e3, relay: r3, expiry: a4, namespaces: l3, acknowledged: true, pairingTopic: E6, requiredNamespaces: h4, optionalNamespaces: I4, controller: o3.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o3.publicKey, metadata: o3.metadata } }, g5 && { sessionProperties: g5 });
        await this.sendResult(s3.id, e3, true), this.events.emit(it("session_connect"), { session: m4 }), this.cleanupDuplicatePairings(m4);
      } catch (r3) {
        await this.sendError(t3, e3, r3), this.client.logger.error(r3);
      }
    }, this.onSessionSettleResponse = async (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? (await this.client.session.update(e3, { acknowledged: true }), this.events.emit(it("session_approve", t3), {})) : isJsonRpcError(s3) && (await this.client.session.delete(e3, w4("USER_DISCONNECTED")), this.events.emit(it("session_approve", t3), { error: s3.error }));
    }, this.onSessionUpdateRequest = async (e3, s3) => {
      const { params: t3, id: i4 } = s3;
      try {
        this.isValidUpdate(w6({ topic: e3 }, t3)), await this.client.session.update(e3, { namespaces: t3.namespaces }), await this.sendResult(i4, e3, true), this.client.events.emit("session_update", { id: i4, topic: e3, params: t3 });
      } catch (r3) {
        await this.sendError(i4, e3, r3), this.client.logger.error(r3);
      }
    }, this.onSessionUpdateResponse = (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(it("session_update", t3), {}) : isJsonRpcError(s3) && this.events.emit(it("session_update", t3), { error: s3.error });
    }, this.onSessionExtendRequest = async (e3, s3) => {
      const { id: t3 } = s3;
      try {
        this.isValidExtend({ topic: e3 }), await this.setExpiry(e3, ot(C5)), await this.sendResult(t3, e3, true), this.client.events.emit("session_extend", { id: t3, topic: e3 });
      } catch (i4) {
        await this.sendError(t3, e3, i4), this.client.logger.error(i4);
      }
    }, this.onSessionExtendResponse = (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(it("session_extend", t3), {}) : isJsonRpcError(s3) && this.events.emit(it("session_extend", t3), { error: s3.error });
      ...
      const { id: t3 } = s3;
      setTimeout(() => {
        isJsonRpcResult(s3) ? this.events.emit(it("session_ping", t3), {}) : isJsonRpcError(s3) && this.events.emit(it("session_ping", t3), { error: s3.error });
      }, 500);
    }, this.onSessionDeleteRequest = async (e3, s3) => {
      const { id: t3 } = s3;
      try {
        this.isValidDisconnect({ topic: e3, reason: s3.params }), await Promise.all([new Promise((i4) => {
          this.client.core.relayer.once(g4.publish, async () => {
      ...
      const { id: t3, params: i4 } = s3;
      try {
        this.isValidRequest(w6({ topic: e3 }, i4)), await this.setPendingSessionRequest({ id: t3, topic: e3, params: i4 });
        const r3 = $n(JSON.stringify(s3)), o3 = this.client.session.get(e3), a4 = await this.getVerifyContext(r3, o3.peer.metadata);
        this.client.events.emit("session_request", { id: t3, topic: e3, params: i4, verifyContext: a4 });
      } catch (r3) {
        await this.sendError(t3, e3, r3), this.client.logger.error(r3);
      }
    }, this.onSessionRequestResponse = (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(it("session_request", t3), { result: s3.result }) : isJsonRpcError(s3) && this.events.emit(it("session_request", t3), { error: s3.error });
    }, this.onSessionEventRequest = async (e3, s3) => {
      const { id: t3, params: i4 } = s3;
      try {
        this.isValidEmit(w6({ topic: e3 }, i4)), this.client.events.emit("session_event", { id: t3, topic: e3, params: i4 });
      } catch (r3) {
        await this.sendError(t3, e3, r3), this.client.logger.error(r3);
      }
      ...
      const { pairingTopic: s3, requiredNamespaces: t3, optionalNamespaces: i4, sessionProperties: r3, relays: o3 } = e3;
      if (I3(s3) || await this.isValidPairingTopic(s3), !jt(o3, true)) {
        const { message: a4 } = N10("MISSING_OR_INVALID", `connect() relays: ${o3}`);
        throw new Error(a4);
      }
      !I3(t3) && F3(t3) !== 0 && this.validateNamespaces(t3, "requiredNamespaces"), !I3(i4) && F3(i4) !== 0 && this.validateNamespaces(i4, "optionalNamespaces"), I3(r3) || this.validateSessionProps(r3, "sessionProperties");
    }, this.validateNamespaces = (e3, s3) => {
      const t3 = $t(e3, "connect()", s3);
      if (t3)
        throw new Error(t3.message);
    }, this.isValidApprove = async (e3) => {
      if (!Dt(e3))
        throw new Error(N10("MISSING_OR_INVALID", `approve() params: ${e3}`).message);
      const { id: s3, namespaces: t3, relayProtocol: i4, sessionProperties: r3 } = e3;
      await this.isValidProposalId(s3);
      const o3 = this.client.proposal.get(s3), a4 = sn(t3, "approve()");
      if (a4)
        throw new Error(a4.message);
      const l3 = an(o3.requiredNamespaces, t3, "approve()");
      if (l3)
        throw new Error(l3.message);
      if (!m3(i4, true)) {
        const { message: h4 } = N10("MISSING_OR_INVALID", `approve() relayProtocol: ${i4}`);
        throw new Error(h4);
      }
      ...
      if (await this.isValidProposalId(s3), !Vt(t3)) {
        const { message: i4 } = N10("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(t3)}`);
        throw new Error(i4);
      }
    }, this.isValidSessionSettleRequest = (e3) => {
      if (!Dt(e3)) {
        const { message: l3 } = N10("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e3}`);
        throw new Error(l3);
      }
      const { relay: s3, controller: t3, namespaces: i4, expiry: r3 } = e3;
      if (!cn(s3)) {
        const { message: l3 } = N10("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(l3);
      }
      const o3 = _t(t3, "onSessionSettleRequest()");
      if (o3)
      ...
      if (a4)
        throw new Error(a4.message);
      if (st(r3)) {
        const { message: l3 } = N10("EXPIRED", "onSessionSettleRequest()");
        throw new Error(l3);
      }
      ...
      const i4 = this.client.session.get(s3), r3 = sn(t3, "update()");
      if (r3)
        throw new Error(r3.message);
      const o3 = an(i4.requiredNamespaces, t3, "update()");
      if (o3)
        throw new Error(o3.message);
      ...
      const { topic: s3, request: t3, chainId: i4, expiry: r3 } = e3;
      await this.isValidSessionTopic(s3);
      ...
      if (!xt(o3, i4, t3.method)) {
        const { message: a4 } = N10("MISSING_OR_INVALID", `request() method: ${t3.method}`);
        throw new Error(a4);
      }
      if (r3 && !zt(r3, $5)) {
        const { message: a4 } = N10("MISSING_OR_INVALID", `request() expiry: ${r3}. Expiry must be a number (in seconds) between ${$5.min} and ${$5.max}`);
        throw new Error(a4);
      }
      ...
      if (await this.isValidSessionTopic(s3), !Kt(t3)) {
      ...
      const { topic: s3, event: t3, chainId: i4 } = e3;
      await this.isValidSessionTopic(s3);
      const { namespaces: r3 } = this.client.session.get(s3);
      if (!Lt(r3, i4)) {
      ...
      const t3 = { verified: { verifyUrl: s3.verifyUrl || "", validation: "UNKNOWN", origin: s3.url || "" } };
      try {
        const i4 = await this.client.core.verify.resolve({ attestationId: e3, verifyUrl: s3.verifyUrl });
        i4 && (t3.verified.origin = i4, t3.verified.validation = i4 === s3.url ? "VALID" : "INVALID");
      } catch (i4) {
        this.client.logger.error(i4);
      }
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: n3 } = N10("NOT_INITIALIZED", this.name);
      throw new Error(n3);
    }
  }
  registerRelayerEvents() {
    this.client.core.relayer.on(g4.message, async (n3) => {
      const { topic: e3, message: s3 } = n3;
      ...
      isJsonRpcRequest(t3) ? (this.client.core.history.set(e3, t3), this.onRelayEventRequest({ topic: e3, payload: t3 })) : isJsonRpcResponse(t3) ? (await this.client.core.history.resolve(t3), this.onRelayEventResponse({ topic: e3, payload: t3 })) : this.onRelayEventUnknownPayload({ topic: e3, payload: t3 });
    });
  }
  registerExpirerEvents() {
    this.client.core.expirer.on(w5.expired, async (n3) => {
      const { topic: e3, id: s3 } = rt(n3.target);
  ...
  isValidPairingTopic(n3) {
    if (!m3(n3, false)) {
      const { message: e3 } = N10("MISSING_OR_INVALID", `pairing topic should be a string: ${n3}`);
      throw new Error(e3);
    }
    if (!this.client.core.pairing.pairings.keys.includes(n3)) {
      const { message: e3 } = N10("NO_MATCHING_KEY", `pairing topic doesn't exist: ${n3}`);
      throw new Error(e3);
    }
    if (st(this.client.core.pairing.pairings.get(n3).expiry)) {
      const { message: e3 } = N10("EXPIRED", `pairing topic: ${n3}`);
      throw new Error(e3);
    }
  }
  async isValidSessionTopic(n3) {
    if (!m3(n3, false)) {
      const { message: e3 } = N10("MISSING_OR_INVALID", `session topic should be a string: ${n3}`);
      throw new Error(e3);
    }
    if (!this.client.session.keys.includes(n3)) {
      const { message: e3 } = N10("NO_MATCHING_KEY", `session topic doesn't exist: ${n3}`);
      throw new Error(e3);
    }
    if (st(this.client.session.get(n3).expiry)) {
      await this.deleteSession(n3);
      const { message: e3 } = N10("EXPIRED", `session topic: ${n3}`);
      throw new Error(e3);
    }
  }
  async isValidSessionOrPairingTopic(n3) {
    if (this.client.session.keys.includes(n3))
      ...
      const { message: e3 } = N10("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${n3}`);
      throw new Error(e3);
    } else {
      const { message: e3 } = N10("MISSING_OR_INVALID", `session or pairing topic should be a string: ${n3}`);
      throw new Error(e3);
    }
  }
  async isValidProposalId(n3) {
    if (!Ct(n3)) {
      const { message: e3 } = N10("MISSING_OR_INVALID", `proposal id should be a number: ${n3}`);
      throw new Error(e3);
    }
    if (!this.client.proposal.keys.includes(n3)) {
      const { message: e3 } = N10("NO_MATCHING_KEY", `proposal id doesn't exist: ${n3}`);
      throw new Error(e3);
    }
    if (st(this.client.proposal.get(n3).expiry)) {
      await this.deleteProposal(n3);
      const { message: e3 } = N10("EXPIRED", `proposal id: ${n3}`);
      throw new Error(e3);
    }
  }
};
var rs2 = class extends zt2 {
  constructor(n3, e3) {
    super(n3, e3, se2, b4), this.core = n3, this.logger = e3;
  }
};
var os2 = class extends zt2 {
  constructor(n3, e3) {
    super(n3, e3, ie2, b4), this.core = n3, this.logger = e3;
  }
};
var as2 = class extends zt2 {
  constructor(n3, e3) {
    super(n3, e3, re2, b4, (s3) => s3.id), this.core = n3, this.logger = e3;
  }
};
var M4 = class extends b2 {
  constructor(n3) {
    super(n3), this.protocol = j4, this.version = J4, this.name = G4.name, this.events = new import_events6.EventEmitter(), this.on = (s3, t3) => this.events.on(s3, t3), this.once = (s3, t3) => this.events.once(s3, t3), this.off = (s3, t3) => this.events.off(s3, t3), this.removeListener = (s3, t3) => this.events.removeListener(s3, t3), this.removeAllListeners = (s3) => this.events.removeAllListeners(s3), this.connect = async (s3) => {
      try {
    ...
    }, this.name = (n3 == null ? void 0 : n3.name) || G4.name, this.metadata = (n3 == null ? void 0 : n3.metadata) || Fn();
    const e3 = typeof (n3 == null ? void 0 : n3.logger) < "u" && typeof (n3 == null ? void 0 : n3.logger) != "string" ? n3.logger : (0, import_logger2.pino)((0, import_logger2.getDefaultLoggerOptions)({ level: (n3 == null ? void 0 : n3.logger) || G4.logger }));
    this.core = (n3 == null ? void 0 : n3.core) || new Rr(n3), this.logger = (0, import_logger2.generateChildLogger)(e3, this.name), this.session = new os2(this.core, this.logger), this.proposal = new rs2(this.core, this.logger), this.pendingRequest = new as2(this.core, this.logger), this.engine = new ns2(this);
  }
...
var WalletConnectWallet = class {
  ...
  async connect() {
    const client = this._client ?? await M4.init(this._options);
  ...
  get publicKey() {
    if (this._client && this._session) {
      const { address } = G2(this._session.namespaces.solana.accounts[0]);
...
tslib/tslib.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=esm-WNOMOXKF.js.map
