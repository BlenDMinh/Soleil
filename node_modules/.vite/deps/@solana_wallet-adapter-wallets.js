...
} from "./chunk-FPTNIKNK.js";
import "./chunk-PFNBEZCN.js";
import {
...
var BloctoWalletAdapter = class extends BaseWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let BloctoClass;
      try {
        BloctoClass = (await import("./blocto-sdk.module-GIOFN32N.js")).default;
      } catch (error) {
...
var BraveWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    ...
    if (this._readyState !== WalletReadyState.Unsupported) {
      scopePollingDetectionStrategy(() => {
        var _a;
        if ((_a = window.braveSolana) == null ? void 0 : _a.isBraveWallet) {
          this._readyState = WalletReadyState.Installed;
          this.emit("readyStateChange", this._readyState);
          return true;
        }
...
var CensoWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let CensoClass;
      try {
        CensoClass = (await import("./esm-LAUMOOR3.js")).CensoWallet;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var ExodusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    ...
    if (this._readyState !== WalletReadyState.Unsupported) {
      scopePollingDetectionStrategy(() => {
        var _a;
        if ((_a = window.exodus) == null ? void 0 : _a.solana) {
          this._readyState = WalletReadyState.Installed;
          this.emit("readyStateChange", this._readyState);
          return true;
        }
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        FractalWalletClass = (await import("./esm-LMKNASJP.js")).FractalWalletAdapterImpl;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var GlowWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    ...
    if (this._readyState !== WalletReadyState.Unsupported) {
      ...
      scopePollingDetectionStrategy(() => {
        var _a;
        if ((_a = window.glowSolana) == null ? void 0 : _a.isGlow) {
          window.removeEventListener("message", handler);
          if (this._readyState !== WalletReadyState.Installed) {
            this._readyState = WalletReadyState.Installed;
            this.emit("readyStateChange", this._readyState);
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("./dist-ABI4VOUH.js");
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        TransportWebHIDClass = (await import("./TransportWebHID-XQIALY2M.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    ...
    try {
      ...
      let WalletClass;
      try {
        ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = await import("./lib-PYXZOY6Y.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("./esm-DMAGAVYV.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
  ...
  async signAllTransactions(transactions) {
    ...
    try {
      ...
      try {
        ...
        if (!data.publicKey || ((_a = data.signatures) == null ? void 0 : _a.length) !== length)
          throw new WalletSignTransactionError(msg);
        const publicKey = new PublicKey(data.publicKey);
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./esm-JUR4RU56.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var BaseSolletWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor({ provider, network = WalletAdapterNetwork.Mainnet, timeout = 1e4 } = {}) {
    ...
    if (this._readyState !== WalletReadyState.Unsupported) {
      if (typeof this._provider === "string") {
        ...
        scopePollingDetectionStrategy(() => {
          var _a;
          if (typeof ((_a = window.sollet) == null ? void 0 : _a.postMessage) === "function") {
            this._readyState = WalletReadyState.Installed;
            this.emit("readyStateChange", this._readyState);
            return true;
          }
  ...
  async connect() {
    try {
      ...
      try {
        SolWalletAdapterClass = (await import("./esm-WNBVVHUO.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var StrikeWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let StrikeClass;
      try {
        StrikeClass = (await import("./esm-GD7UTSGJ.js")).StrikeWallet;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("./solanaEmbed.esm-GXJ7CJ72.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var UnsafeBurnerWalletAdapter = class extends BaseSignerWalletAdapter {
  constructor() {
    super();
...
var WalletConnectWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WCChainID;
      try {
        ({ WalletConnectWallet: WalletConnectClass, WalletConnectChainID: WCChainID } = await import("./esm-WNOMOXKF.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
