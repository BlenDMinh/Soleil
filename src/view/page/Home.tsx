    ...
    <App id={0}>
      <div className="h-full w-full flex flex-col items-center bg-zinc-100 p-16">
        <div className="w-auto flex flex-col items-start gap-8">
          <div className="w-full bg-white h-64 justify-center">
            <img src="https://www.freepik.com/free-vector/volunteers-packing-donation-boxes_7732672.htm#query=charity&position=23&from_view=search&track=sph" alt="Profile Image" className="w-full h-64 " />
          </div>
